        ...
        <div class="contact_box_widget widget_box"> 
            ...
            <?php if(! empty($instance['backgroundimage'])) : ?> 
                ...
                <?php if(! empty($instance['phonenumber'])) : ?> 
                    <a href="tel:<?php echo esc_url($instance['phonenumber']); ?>" class="phone_number"><?php echo wp_kses_post($instance['phonenumber']); ?></a>
		        <?php endif; ?>
                <?php if(! empty($instance['mailid'])) : ?> 
                    <a href="mailto:<?php echo esc_url($instance['mailid']); ?>" class="mailid"><?php echo wp_kses_post($instance['mailid']); ?></a>
		        <?php endif; ?>
                </div>
