<?php
   ...
   class Widget_creote_header_v8 extends Widget_Base
   {
   
       public function get_name()
       {
           return 'creote-header-v8';
       }
   
       public function get_title()
       {
           return __('Header V7', 'creote-addons');
       }
           ...
           [
               ...
               'default' => [
                   [
                      ...
                      'social_media_icons' =>  __('fa fa-facebook', 'creote-addons'),
                      'socail_media_links' =>  __('#', 'creote-addons'),
                   ],
                   [
                       'media_icon_enable' => 'text_type' ,
                       'social_media_text' =>  __('Tw', 'creote-addons'),
                      'social_media_icons' =>  __('fa fa-twitter', 'creote-addons'),
                      'socail_media_links' =>  __('#', 'creote-addons'),
                    ],
                    [
                       'media_icon_enable' => 'text_type' ,
                       'social_media_text' =>  __('Sk', 'creote-addons'),
                       'social_media_icons' =>  __('fa fa-skype', 'creote-addons'),
                       'socail_media_links' =>  __('#', 'creote-addons'),
                    ],
                    [
                       'media_icon_enable' => 'text_type' ,
                       'social_media_text' =>  __('Ln', 'creote-addons'),
                       'social_media_icons' =>  __('fa fa-telegram', 'creote-addons'),
                       'socail_media_links' =>  __('#', 'creote-addons'),
                    ],
               ],
       ...
       $this->add_responsive_control(
           ...
           [
             ...
             'selectors' => [
               '{{WRAPPER}} .header.style_seven.style_eight  ' => 'position: {{VALUE}};',
            ],
           ]
       );
       $this->add_responsive_control(
           'header_bg_color',
            [
               ...
               'type' => Controls_Manager::COLOR,
                'selectors' => [
                   '{{WRAPPER}} .header.style_seven.style_eight ' => 'background: {{VALUE}};',
                 ],
            ]
         );
       $this->add_responsive_control(
           'mennu_color',
            [
               ...
               'type' => Controls_Manager::COLOR,
               'selectors' => [
                   '{{WRAPPER}} .header.style_seven.style_eight  .header_content_collapse .navigation_menu .navbar_nav li a.nav-link ' => 'color: {{VALUE}};',
                   '{{WRAPPER}} .header.style_seven.style_eight  .header_content_collapse .navigation_menu  .navbar_nav li .dropdown-btn span:before ' => 'color: {{VALUE}}; opacity:.4;',
               ],
            ]
         );
       $this->add_responsive_control(
           'mennu_right_icon_color',
            [
               ...
               'type' => Controls_Manager::COLOR,
               'selectors' => [
                   '{{WRAPPER}} .header.style_seven.style_eight  .header_right_content ul li .search-toggler i, {{WRAPPER}}  .header.style_seven.style_eight  .header_right_content ul li .header_side_cart i, {{WRAPPER}}  .header.style_seven.style_eight  .header_right_content ul li .contact-toggler i
       ...
       $this->add_responsive_control(
           'cart_count_color',
            [
               ...
               'type' => Controls_Manager::COLOR,
               'selectors' => [
                   '{{WRAPPER}} .header.style_seven.style_eight .header_right_content ul .header_side_cart .mini-cart-count ' => 'color: {{VALUE}};',
               ],
            ]
       );
       $this->add_responsive_control(
           'cart_bg_count_color',
            [
               ...
               'type' => Controls_Manager::COLOR,
               'selectors' => [
                   '{{WRAPPER}} .header.style_seven.style_eight  .header_right_content ul .header_side_cart .mini-cart-count ' => 'background: {{VALUE}};',
               ],
            ]
       );
       ...
       $this->add_responsive_control(
           'right_btn_color',
            [
               ...
               'type' => Controls_Manager::COLOR,
               'selectors' => [
                   '{{WRAPPER}} .header.style_seven.style_eight  .header_right_content ul li.last a ' => 'color: {{VALUE}};',
               ],
            ]
       );
       ...
       $this->add_responsive_control(
           'extra_border_color',
            [
               ...
               'type' => Controls_Manager::COLOR,
               'selectors' => [
                   '{{WRAPPER}} .header.style_seven.style_eight  .header_right_content ul li.last::before ' => 'background: {{VALUE}};',
                   '{{WRAPPER}} .header_default.style_seven  .modal_box_buttom::before ' => 'background: {{VALUE}};',
       ...
       $this->add_responsive_control(
           'media_color',
            [
               ...
               'type' => Controls_Manager::COLOR,
               'selectors' => [
                   '{{WRAPPER}} .header_default.style_seven.style_eight .header_right_content ul li .med_rg_side .social_media_head li a i ,
                   .header_default.style_seven.style_eight .header_right_content ul li .med_rg_side .social_media_head li a small ' => 'color: {{VALUE}};',
               ],
            ]
       );
       $this->add_responsive_control(
           'media_border_color',
            [
               ...
               'type' => Controls_Manager::COLOR,
               'selectors' => [
                   '{{WRAPPER}} .header_default.style_seven.style_eight .header_right_content ul li .med_rg_side .social_media_head li a ' => 'border-color: {{VALUE}};',
               ],
            ]
       );
       ...
       protected function render()
       {
           ...
           ?>
<header class="header header_default style_seven style_eight head_<?php echo esc_attr($settings['header_positions']); ?>">
         ...
         <div class="col-lg-4 col-md-3 col-sm-3 col-xs-3 right_column">
            <div class="header_right_content">
               <ul>
                  ...
                  <?php endif;?>
                  <?php if($settings['button__text_enable'] == 'yes'): ?>
                  <li class="last"> 
                     <?php $target_four = $settings['button_text_link']['is_external'] ? ' target="_blank"' : '';
                        $nofollow_four = $settings['button_text_link']['nofollow'] ? ' rel="nofollow"' : ''; ?>
                     <a href="<?php echo esc_url($settings['button_text_link']['url']); ?>" <?php echo esc_attr($target_four); ?> <?php echo esc_attr($nofollow_four); ?> class="login"> <i class="icon-keyhole"></i>  <?php echo esc_attr($settings['button_link_text']); ?> </a>
                  </li>
                  <li>
                     <?php endif;?>
                     <?php if($settings['scoial_media_enables'] == 'yes'): ?>
                     <div class="med_rg_side">
                        <ul class="social_media_head">
                           <?php foreach($settings['social_media_repeaters'] as  $media_repearter):?>
                           <?php $targetm = $media_repearter['socail_media_links']['is_external'] ? ' target="_blank"' : '';
                              $nofollowm = $media_repearter['socail_media_links']['nofollow'] ? ' rel="nofollow"' : ''; ?>
                           <li>   <a href="<?php echo esc_url($media_repearter['socail_media_links']['url']); ?>" <?php echo esc_attr($targetm); ?> <?php echo esc_attr($nofollowm); ?>>
                              <?php if($media_repearter['media_icon_enable'] == 'text_type'): ?>
                              <small><?php echo esc_attr($media_repearter['social_media_text']); ?></small>
                              <?php  elseif($media_repearter['media_icon_enable'] == 'icon_type'): ?>
                              <i class="<?php echo esc_attr($media_repearter['social_media_icons']); ?>"></i>
                              <?php endif; ?>
                              </a>
                           </li>
                           <?php endforeach;?>
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_creote_header_v8());