           ...
           $this->add_control(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .floating_menu_box  ' => 'color: {{VALUE}}!important;',
                ],
                ]
            );
...
<div class="floating_menu_box">
    ...
    <i class="close fa fa-times"></i>
        <?php foreach($settings['floating_repater_menu'] as $key => $floating_repater_menu):
              $target = $floating_repater_menu['floating_menu_link']['is_external'] ? ' target="_blank"' : '';
              $nofollow = $floating_repater_menu['floating_menu_link']['nofollow'] ? ' rel="nofollow"' : ''; 
            ?> 
        <li class="floating_menu_text <?php if($key == 0) echo 'active';?>">
            <a href="<?php echo esc_url($floating_repater_menu['floating_menu_link']['url']); ?>"  <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>>
                <?php if($floating_repater_menu['icon_switch'] == 'yes'): ?> 
                    <i class="<?php echo esc_attr($floating_repater_menu['icon_fonts']); ?>"></i> 
                <?php endif; ?>
                <?php echo wp_kses($floating_repater_menu['floating_menu_text'] , $allowed_tags); ?>
            </a>
        </li>
        <?php endforeach; ?>
    </ul>
