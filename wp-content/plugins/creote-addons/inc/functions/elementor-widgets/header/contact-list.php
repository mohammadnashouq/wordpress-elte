<?php
   ...
   class Widget_creote_contact_list_v1 extends Widget_Base
   {
       ...
       protected function render()
       {
           ...
           ?>
<div class="contact_list <?php echo esc_attr($settings['contact_list_style']); ?>">
   <?php if($settings['items_contact'] ==  'mail_id'): ?>
   <div class="same_contact mail">
      <a href="mailto:<?php echo esc_attr($settings['mail_id_text']); ?>"><span class="icon-email"></span><?php echo esc_attr($settings['mail_id_text']); ?></a>
   </div>
   <?php elseif($settings['items_contact'] ==  'phone_number'): ?>
   <div class="same_contact phone">
      <a href="tel:<?php echo esc_attr($settings['phone_number_text']); ?>"><span class="icon-phone-call"></span><?php echo esc_attr($settings['phone_number_text']); ?></a>
   </div>
   <?php elseif($settings['items_contact'] ==  'address'): ?>
   <div class="same_contact address">
      <p><span class="icon-placeholder"></span><?php echo esc_attr($settings['address_text']); ?></p>
   </div>
   <?php endif; ?>
</div>
<?php
