            ...
            <div class="col-lg-12">
               <div class="top_inner">
                  ...
                  <div class="right_side common_css">
                     <?php if($settings['media_icon_enable'] == 'yes'): ?>
                     ...
                     <div class="contntent button">
                        ...
                        <a href="<?php echo esc_url($settings['button_link']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?> class="theme-btn one">  <?php echo esc_attr($settings['button_text']); ?> <i class="icon-right-arrow-1"></i> </a>
                     </div>
                     <?php endif; ?>
                  </div>
               </div>
