                     ...
                     <div class="rg_content_box">
                        ...
                        <div  class="btn_lf_side">
                           <?php  
                              ...
                              ?>
                           <a href="<?php echo esc_url($settings['button_link']['url']) ?>" class="top_six_btn" <?php echo esc_attr($target_two); ?> <?php echo esc_attr($nofollow_two); ?>> <?php echo wp_kses($settings['button_text'] ,  $allowed_tags); ?></a>   </li>
                        </div>
                        <?php endif; ?>
