           ...
           $this->add_responsive_control(
               'mennu_color',
                [
                   ...
                   'type' => Controls_Manager::COLOR,
                   'selectors' => [
                       '{{WRAPPER}} .header.header_default.style_nine  .header_content_collapse .navigation_menu .navbar_nav li a.nav-link ' => 'color: {{VALUE}};',
                   ],
                ]
             );
           $this->add_responsive_control(
...
<header class="header header_default style_nine pack_two_<?php echo esc_attr($settings['header_styles']); ?>">
   ...
   <div class="d-flex align-items-center">
            ...
            <div class="header_logo_box">
               ...
               <img src="<?php echo esc_url($settings['logo_defaults']['url']); ?>" alt="<?php echo esc_html(get_bloginfo( 'name' )); ?>" class="logo_defaults">
         ...
         <?php if($settings['search_enable'] == 'yes' || $settings['button__text_enable'] == 'yes'): ?>
            ...
            <div class="header_right_content d-flex align-items-center">
                 <?php if($settings['search_enable'] == 'yes'): ?>
                  ...
                  <?php if($settings['button__text_enable'] == 'yes'): ?>
                     ...
                     <?php $target_four = $settings['button_text_links']['is_external'] ? ' target="_blank"' : '';
                        $nofollow_four = $settings['button_text_links']['nofollow'] ? ' rel="nofollow"' : ''; ?>
                     <a href="<?php echo esc_url($settings['button_text_links']['url']); ?>" <?php echo esc_attr($target_four); ?> <?php echo esc_attr($nofollow_four); ?> class="theme-btn one">  <?php echo esc_attr($settings['button_link_texts']); ?> </a>
