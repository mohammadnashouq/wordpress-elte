            ...
            <div class="top_inner">
               <div class="left_side common_css">
                  <div class="contntent address">
                     ...
                     <div class="text">
                        <?php if(!empty($settings['location_title'])): ?>
               ...
               <div class="right_side common_css">
                  ...
                  <div class="contntent media">
                     ...
                     <div class="text">
                        <?php if(!empty($settings['share_title'])): ?>
                        <small><?php echo esc_attr($settings['share_title']); ?></small>
                        <?php endif; ?>
                        ...
                        <a href="<?php echo esc_url($media_repearter['socail_media_link']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>>
                        <?php if($media_repearter['media_icon_enable'] == 'no'): ?>
                        <small><?php echo esc_attr($media_repearter['social_media_text']); ?></small>
                        <?php  elseif($media_repearter['media_icon_enable'] == 'yes'): ?>
...
<?php endif;?>
<header class="header header_default style_one <?php echo esc_attr($settings['header_styles']); ?>">
   <div class="<?php echo esc_attr($settings['header_width']); ?>">
