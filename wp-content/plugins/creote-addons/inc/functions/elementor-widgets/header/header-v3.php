          ...
          $this->add_control(
           ...
           $this->add_control(
               ...
               [
                   ...
                   'default' => [
                       [
                          'icon_fonts' =>  __('fa fa-facebook', 'creote-addons'),
...
<header class="header header_default style_three">
   ...
   <div class="header_mid">
      <div class="medium-container">
         <div class="row align-items-center">
            <?php if(!empty($settings['logo_default']['url'])): ?>
            <div class="col-lg-3 col-md-12">
               <div class="logo mid_logo_icon">
                  <a href="<?php echo esc_url($url); ?>" class="logo_mid" <?php echo esc_attr($logo_target); ?> <?php echo esc_attr($logo_nofollow); ?>>
            ...
            <div class="col-lg-9 col-md-12">
               <div class="row">
                  <?php foreach($settings['information_repeater'] as $information_repeater):?>
   ...
   <?php endif; ?>   
   <div class="navbar_outer  <?php if($settings['modal_enable'] == 'yes'): ?> mod_btn_enable  <?php endif; ?>">
      <div class="medium-container">
         <div class="row align-items-center">
                  ...
                  <div class="header_right_content">
                     <ul>
                        ...
                        <li> 
                           ...
                           <a href="<?php echo esc_url($settings['button_link']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?> class="theme-btn five">  <?php echo esc_attr($settings['button_text']); ?> </a>
                        </li>
                        <?php endif;?>
                     </ul>
                  </div>
