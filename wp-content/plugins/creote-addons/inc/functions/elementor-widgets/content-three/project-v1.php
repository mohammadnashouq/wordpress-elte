...
<?php if($settings['project_box_type'] == 'carousel') : ?>
<section class="project_all_styles carousel owl_new_one">
    ...
    <div class="owl-carousel  <?php echo $settings['owl_nav_block'] ?> <?php echo $settings['owl_dots_block'] ?> <?php echo $settings['owl_nav_postion'] ?>  theme_carousel owl-theme owl-carousel"
        ...
        <?php
                    ...
                    if( $settings['query_category'] ) $args['project_category'] = $settings['query_category'];
        ...
        <article id="post-<?php esc_attr(the_ID()); ?>" <?php esc_attr(post_class()); ?>>
            <?php if($settings['project_style'] == 'style_one'):?>
            ...
            <div class="project_box type_one">
                ...
                <div class="content_box">
                    ...
                    if(!empty($output_cat)): ?>
                        ...
                        <?php endif; ?>
                        <a href="<?php  esc_url( get_permalink() ); ?>" class="read_more_link"><span
            ...
            <?php if($settings['project_style'] == 'style_two'):?>
            ...
            <div class="project_box type_two">
                ...
                <div class="content_box ">
                    ...
                    <a href="<?php  esc_url( get_permalink() ); ?>"
                        class="read_more"><?php echo esc_html('Read More ' , 'creote'); ?><span
                            class="icon-arrow-right"></span></a>
                </div>
            </div>
            <?php endif; ?>
...
<?php if($settings['project_box_type'] == 'grid') : ?>
<section class="project_all_styles">
   ...
   if(!empty($output_cat)): ?>
                ...
                <?php elseif($settings['project_style'] == 'style_two'):?>
   ...
   <div class="row">
      <div class="col-lg-12">
         <div class="pagination text-center service">
            <?php
