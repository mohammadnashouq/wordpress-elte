...
class Widget_creote_icon_box_carousel_v1 extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        ?>
<section class="icon_carousel_box_all">
    <div class="<?php echo $settings['owl_dots_block'] ?> theme_carousel owl-theme owl-carousel"
        data-options='{"loop": true, "margin": 20, "autoheight":true, "lazyload":true, "nav": false, "dots": true, "autoplay": true, "autoplayTimeout": 7000, "smartSpeed": 1800, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "3" } , "1000":{ "items" : "<?php echo esc_attr($settings['items_to_display']); ?>" }}}'>


        <?php foreach($settings['icon_box_caro_content_v1_repeater'] as $icon_carouse_content):
             $target = $icon_carouse_content['link']['is_external'] ? ' target="_blank"' : '';
             $nofollow = $icon_carouse_content['link']['nofollow'] ? ' rel="nofollow"' : ''; 
            ?>

        <div class="icon_caro type_one">
            <div class="icon">
                <?php if($icon_carouse_content['icon_image_enable'] == 'yes' && $icon_carouse_content['icon_fonts_enable'] !== 'yes'  ) : ?>
                <img src="<?php echo esc_url($icon_carouse_content['icon_image']['url']); ?>"
                    class="img-fluid svg_image" alt="<?php esc_attr_e('icon png', 'creote-addons'); ?>" />
                <?php endif; ?>
                <?php if($icon_carouse_content['icon_image_enable'] !== 'yes' && $icon_carouse_content['icon_fonts_enable'] == 'yes'  ) : ?>
            ...
            <div class="text">
                <h2><a <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>
                        href="<?php echo esc_url($icon_carouse_content['link'] ['url']); ?>"><?php echo esc_html($icon_carouse_content['icon_heading_text']); ?></a>
                </h2>
                <p><?php echo esc_html($icon_carouse_content['icon_description']); ?></p>
                <?php if($icon_carouse_content['read_more_enable'] == 'yes'): ?>
                <a href="<?php echo esc_url($icon_carouse_content['link'] ['url']); ?>"
                    class="read_more type_one"><?php echo esc_html($icon_carouse_content['read_more_btn']); ?><span
