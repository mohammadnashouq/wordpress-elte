...
class Widget_creote_theme_btn_v1_new extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        ?> 
    <div class="theme_btn_all_new <?php echo $settings['button_align_ment']; ?>">
    <?php if($settings['button_types'] == 'type_one'): ?>
          <a href="<?php echo esc_url($settings['button_link'] ['url']); ?>" class="theme_btn <?php echo $settings['button_types']; ?>"
          <?php echo esc_attr($button_target); ?> <?php echo esc_attr($button_nofollow); ?>>
            <?php echo esc_html($settings['button_text']); ?> 
          <?php if($settings['button_icon']) : ?>
          <span class="<?php echo $settings['button_icon']; ?>"></span>
          <?php endif; ?>
        </a>
    <?php elseif($settings['button_types'] == 'r_type_one'): ?>
        <a href="<?php echo esc_url($settings['button_link'] ['url']); ?>" class="read_more <?php echo $settings['button_types']; ?>"
        <?php echo esc_attr($button_target); ?> <?php echo esc_attr($button_nofollow); ?>><?php echo esc_html($settings['button_text']); ?> 
          <?php if($settings['button_icon']) : ?>
          <span class="<?php echo $settings['button_icon']; ?>"></span>
          <?php endif; ?>
        </a>
