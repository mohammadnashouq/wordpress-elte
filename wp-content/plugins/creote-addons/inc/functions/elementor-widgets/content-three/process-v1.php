            ...
            $this->add_control(
                'count_number_text_color',
                 [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .choose_box.type_one .step_no , {{WRAPPER}} .choose_box.type_two .step h6 , {{WRAPPER}}  .choose_box.type_three .step_no' => 'color: {{VALUE}}!important; opacity:1;',
                    ],
                 ]
            );
            $this->add_control(
          ...
          $this->add_control(
            'heading_color',
             [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .choose_box.type_one .text_box h2 a , {{WRAPPER}} .choose_box.type_two .content_box h2 a , {{WRAPPER}} .choose_box.type_three .content_box h2 a' => 'color: {{VALUE}}!important;',
                ],
             ]
          );
          ...
          $this->add_control(
            'ho_heading_color',
             [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .choose_box.type_one:hover .text_box h2 a' => 'color: {{VALUE}}!important;',
                ],
                'condition' => [
                    'process_style' => 'type_one',
                 ]
...
<section class="why_choose_us type_one">
    <div class="row">
        <?php if($settings['process_style'] == 'type_one' || $settings['process_style'] == 'type_two'):
            $target1 = $settings['link']['is_external'] ? ' target="_blank"' : '';
            $nofollow1 = $settings['link']['nofollow'] ? ' rel="nofollow"' : ''; 
        ?>

       
        <?php if($settings['process_style'] == 'type_one'): ?>
            <div class="choose_box  type_one">
                <div class="image_box">
                    <?php if($settings['icon_image_select'] == 'icon_image_enable'): ?>
                    <img src="<?php echo esc_url($settings['icon_image']['url']); ?>" class="img-fluid svg_image"
                        alt="<?php esc_attr_e('icon png', 'creote-addons'); ?>" />
            ...
            <?php elseif($settings['process_style'] == 'type_two'): ?>
            <div class="choose_box type_two">
                ...
                <div class="step">
                    <h6 class="step_no"><?php echo esc_html($settings['number_icon_fonts']); ?></h6>
                </div>
            </div>

        <?php endif; // style one two ?>
        ...
        ?>
            ...
            <div class="choose_box type_three">
                <div class="image">
                    <img src="<?php echo esc_url($settings['image']['url']); ?>" class="img-fluid" alt="image" />
                </div>
                <div class="content_box">
                    <h2> 
