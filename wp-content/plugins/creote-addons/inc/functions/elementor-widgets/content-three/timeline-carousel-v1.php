...
<section class="time_line_carousel_box owl_new_one">
       ...
       <div class="owl-carousel <?php echo $settings['owl_nav_block'] ?> <?php echo $settings['owl_dots_block'] ?> <?php echo $settings['owl_nav_postion']; ?>  theme_carousel owl-theme owl-carousel"
        data-options='{"loop": true, "margin": 10, "autoheight":true, "lazyload":true, <?php if($settings['center_enable']):?> "center": true ,<?php endif; ?>  "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 7000, "smartSpeed": 1800, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "3" } , "1000":{ "items" : "<?php echo esc_attr($settings['items_to_display']); ?>" }}}'>
             

       <?php foreach($settings['timeline_caro_content_v1_repeater'] as $timelineco):
         $target1 = $timelineco['link']['is_external'] ? ' target="_blank"' : '';
        $nofollow1 = $timelineco['link']['nofollow'] ? ' rel="nofollow"' : ''; 
        ?>    <div class="time_box type_one ">
                                <?php  if(!empty($timelineco['date_helde'])) : ?>
                                    <div class="date_box ">
                                        <h6><?php echo esc_html($timelineco['date_helde']); ?></h6>
                                    </div>
                                <?php endif; ?>
                                    <div class="content_box ">
                                    <h2><?php echo esc_html($timelineco['time_heading_text']); ?></h2>
                                    <p><?php echo esc_html($timelineco['time_description']); ?></p>
                                    <?php if($timelineco['read_more_enable'] == 'yes'): ?>
                                       <a  <?php echo esc_attr($target1); ?> <?php echo esc_attr($nofollow1); ?> href="<?php echo esc_url($timelineco['link'] ['url']); ?>" class="read_more type_two"><?php echo esc_html($timelineco['read_more_btn']); ?><span class="icon-arrow-right"></span></a>
                                  <?php endif; ?>
                                    </div>
                                </div>
