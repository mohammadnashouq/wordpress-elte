...
<div class="image_box_new clearfix type_four">
    <div class="left">
    ...
    <?php endif; ?>
    <div class="right">
        <?php if(!empty($settings['image_three'])): ?>
        <div class="image three">
            <img src="<?php echo esc_url($settings['image_three']['url']); ?>" class="img-fluid" alt="img">
        </div>
        <?php endif; ?>
...
<?php elseif($settings['image_box_style'] == 'type_two'): ?>
    <div class="image_box_new clearfix type_five">
    <div class="left">
        <?php if(!empty($settings['image_one'])): ?>
        <div class="image one">
            <img src="<?php echo esc_url($settings['image_one']['url']); ?>" class="img-fluid" alt="img">
  ...
  <div class="percent">
    <svg>
      ...
      <circle cx="105" cy="105" r="100" style="--percent: <?php echo esc_html($settings['progress_bar_number']); ?>"></circle>
    </svg>
    <div class="number">
      <h3><?php echo esc_html($settings['progress_bar_number']); ?><span><?php echo esc_html('%' , 'creote-addons'); ?></span></h3>
    </div>
  </div>
