...
<section class="project_v1 project_tabs">
        ...
        <div class="col-sm-12">
            <div class="fliter_group <?php echo esc_attr($settings['project_filter_box_style']);?> project_posts">
                <ul class="project_filter clearfix">
                    ...
                    <li data-filter=".project_category-<?php echo ($term->slug); ?>"><?php echo $term->name; ?></li>
                    <?php } ?>
                </ul>
            </div>
        </div>
...
<?php endif;?>
    ...
    <div class="projectcontainer">
        ...
        <?php $paged = ( get_query_var('paged') ) ? get_query_var('paged') : 1;
            ...
            $term_slug = '';
            if($post_terms) foreach($post_terms as $p_term) $term_slug .= $project_category . '-' . $p_term->slug.' ';
            ?>

        <article class="project-wrapper <?php echo esc_attr($column_name); ?> <?php echo esc_attr($term_slug); ?>">
            <?php if($settings['project_filter_style'] == 'style_one'):?>
