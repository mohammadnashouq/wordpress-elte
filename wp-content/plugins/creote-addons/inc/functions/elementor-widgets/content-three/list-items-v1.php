...
<ul class="list_items_new_box type_one <?php if($settings['display_inline'] == 'yes'): ?> display_inline <?php endif; ?>">
    <?php foreach($settings['listiems_content_v1_repeater'] as $listitemsblock): 
        $website_link_target = $listitemsblock['website_link']['is_external'] ? ' target="_blank"' : '';
        $website_link_nofollow = $listitemsblock['website_link']['nofollow'] ? ' rel="nofollow"' : ''; 
    ?>
    <li>
        <a href="<?php echo esc_url($listitemsblock['website_link'] ['url']); ?>"
            <?php echo esc_attr($website_link_target); ?> <?php echo esc_attr($website_link_nofollow); ?>>
            <span class="<?php echo esc_html($listitemsblock['icon_fonts']); ?> icon"></span>
            <?php echo wp_kses($listitemsblock['list_cotnent'] , $allowed_tags); ?>
        </a>
    </li>
    <?php endforeach; ?>
</ul>
