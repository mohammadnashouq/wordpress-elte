        ...
        $this->add_control(
            'contact_heading_color',
             [
                ...
                'type' => Controls_Manager::COLOR,
                 'selectors' => [
                    '{{WRAPPER}} .info_section .info_inner .info-box .box h4 ' => 'color: {{VALUE}}!important;',
                  ],
             ]
          );
        ...
        $this->add_control(
            'hover_contact_heading_color',
             [
                ...
                'type' => Controls_Manager::COLOR,
                 'selectors' => [
                    '{{WRAPPER}}  .info_section .info_inner .info-box:hover .box h4 , {{WRAPPER}} .info_section .info_inner .info-box.active .box h4 ' => 'color: {{VALUE}}!important;',
                  ],
                        ...
                        <div class="<?php echo esc_attr($settings['column_count']); ?>  info-column">
                           <div class="info-box <?php echo esc_attr($contact_box['active_contact_bg']); ?>">
                              ...
                              <div class="box">
                                 ...
                                 <div class="heading-box"> <h4><?php echo esc_html($contact_box['box_heading_text']); ?></h4>
                                 <span><?php echo esc_html($contact_box['box_description']); ?></span></div>
                              </div>
                              <div class="text">
                                  ...
                                  <?php if($contact_box['email_enable'] == 'yes'):?>
                                    ...
                                    <p><a href="mailto:<?php echo esc_url($contact_box['emailtxtone']); ?>"><?php echo esc_html($contact_box['emailtxtone']); ?></a></p>
                                   <?php endif; ?>
                                   <?php if(!empty($contact_box['emailtxttwo'])):?>
                                    <p><a href="mailto:<?php echo esc_url($contact_box['emailtxttwo']); ?>"><?php echo esc_html($contact_box['emailtxttwo']); ?></a></p>
                                   <?php endif; ?>
                                  <?php endif; ?>
                                  <?php if($contact_box['phone_enable'] == 'yes'):?>
                                    <?php if(!empty($contact_box['phoneno'])):?>
                                    <p><a href="tel:<?php echo esc_url($contact_box['phoneno']); ?>"><?php echo esc_html($contact_box['phoneno']); ?></a></p>
                                   <?php endif; ?>
                                   <?php if(!empty($contact_box['phonenotwo'])):?>
                                    <p><a href="mailto:<?php echo esc_url($contact_box['phonenotwo']); ?>"><?php echo esc_html($contact_box['phonenotwo']); ?></a></p>
                                   <?php endif; ?>
                                  <?php endif; ?>
                              </div>
                           </div>
