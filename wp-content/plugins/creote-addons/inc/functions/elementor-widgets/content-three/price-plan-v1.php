...
?>
<?php if($settings['priceplan_box_style'] == 'type_one'): ?>

<div class="pricing_plan_box type_one">
    <?php if(!empty($settings['tag'])): ?>
    <div class="tags"><?php echo esc_html($settings['tag']); ?></div>
    <?php endif; ?>
    <div class="pricing_plan_box_inner">
        <div class="upper_content">
            ...
            <div class="price_rs">
                <h6><small><?php echo esc_html($settings['price']); ?></small> <?php echo esc_html('/');?>
                    <span><?php echo esc_html($settings['month']); ?></span></h6>
            </div>
            <?php endif; ?>
        ...
        <div class="lower_content">
            <ul>
                <?php foreach($settings['price_benifits_repeater'] as $price_list):?>
                <li>
                <?php if($price_list['yesno'] == 'yes'): ?>
                    <span class="yes_ico fa fa-check-circle-o"></span>
                <?php elseif($price_list['yesno'] == 'no'): ?>
                    <span class="no_ico fa fa-times-circle-o"></span>
                <?php endif; ?>
                    <?php echo esc_html($price_list['list_items']); ?>
                </li>
                <?php endforeach; ?>
            </ul>
        </div>

        <?php if(!empty($settings['getstartbtn'])) : ?>
        <div class="get_start_button theme_btn_all">
            <a href="<?php echo esc_url($settings['getstartbtnlink']['url']); ?>"  <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>
                class="theme-btn one"><?php echo esc_html($settings['getstartbtn']); ?><span
                    class="icon-arrow-right"></span></a>
        </div>
        <?php endif; ?>
    </div>
</div>
<?php elseif($settings['priceplan_box_style'] == 'type_two'): ?>
<div class="pricing_plan_box type_two">
    <?php if(!empty($settings['tag'])): ?>
    <div class="tags"><?php echo esc_html($settings['tag']); ?></div>
    <?php endif; ?>
    <div class="price_box">
        <div class="price">
            <?php if(!empty($settings['price'])) : ?>
            <h6><?php echo esc_html($settings['price']); ?> </h6>
            <p><?php echo esc_html($settings['month']); ?></p>
            <?php endif; ?>
        </div>
        <div class="lower_content">
            <?php if(!empty($settings['title'])) : ?>
    ...
    <div class="hover_content">
        <ul>
            ...
            <li> 
                <?php if($price_list['yesno'] == 'yes'): ?>
                    <span  class="yes_ico fa fa-check-circle-o"></span>
                <?php elseif($price_list['yesno'] == 'no'): ?>
                    <span  class="no_icon fa fa-times-circle-o"></span>
                <?php endif; ?>
                    <?php echo esc_html($price_list['list_items']); ?>
            </li>
            <?php endforeach; ?>
        ...
        <div class="get_start_button theme_btn_all">
            <a href="<?php echo esc_url($settings['getstartbtnlink']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>
                class="theme-btn one"><?php echo esc_html($settings['getstartbtn']); ?></a>
        </div>
        <?php endif; ?>
    </div>
</div <?php endif; ?> <?php
