...
<?php if($settings['service_box_type'] == 'carousel') : ?>
<section class="service_all_styles carousel owl_new_one">
  <div class="owl-carousel <?php echo $settings['owl_nav_block'] ?> <?php echo $settings['owl_dots_block'] ?> <?php echo $settings['owl_nav_postion'] ?> theme_carousel owl-theme owl-carousel"
        data-options='{"loop": true, "margin": 20, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 7000, "smartSpeed": 1800, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "3" } , "1000":{ "items" : "<?php echo esc_attr($settings['items_to_display']); ?>" }}}'>
                <?php 
                     $args = array(
                        'post_type' => 'service',
                ...
                <article id="post-<?php esc_attr(the_ID()); ?>" <?php esc_attr(post_class()); ?>>
                    <?php if($settings['service_style'] == 'type_one' || $settings['service_style'] == 'type_three'):?>
                    <div class="service_box  <?php echo esc_attr($settings['service_style']); ?> clearfix">
                        ...
                        <div class="content_box">
                            ...
                            <?php if(!empty($service_icon)): ?>
                                <div class="icon_box_inner">
                                    <i class="<?php echo esc_attr($service_icon);  ?> icon"></i>
                                </div>
                            ...
                            <?php the_excerpt('<p>','</p>' ); ?>
                            <?php endif; ?>
                            <?php if($settings['service_style'] == 'type_one'):?>
                    ...
                    <?php if($settings['service_style'] == 'type_two' ):?>

                    <div class="service_box type_two clearfix">
                        ...
                        <div class="btn_box">
                            <a href="<?php  echo esc_url( get_permalink() );  ?>" class="read_more type_two"><span
                                    class="icon-arrow-right"></span><?php echo esc_html($settings['read_more']); ?></a>
                        </div>
                    </div>
                    <?php endif;?>
                </article>
...
<?php if($settings['service_box_type'] == 'grid') : ?>
<section class="service_all_styles ">
    <div class="row">
        ...
        $service_icon_images =   rwmb_meta( 'service_icon_image', array( 'size' => 'thumbnail' ) );
        ?>
        <div class="<?php echo esc_attr($settings['column_count']); ?> col-md-4 col-sm-6 col-xs-12">
            ...
            <?php if($settings['service_style'] == 'type_one' || $settings['service_style'] == 'type_three'):?>
                ...
                <?php elseif($settings['service_style'] == 'type_two'):?>
        ...
        <?php if($settings['pagination_enable_dis'] == 'yes'):?>
