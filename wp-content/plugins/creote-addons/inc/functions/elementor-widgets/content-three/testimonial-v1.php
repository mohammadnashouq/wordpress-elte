...
<section
    class="testimonial_all carousel owl_new_one">
        ...
        data-options='{"loop": true, "margin": 10, "autoheight":true, "lazyload":true, "nav": false, "dots": true, "autoplay": true, "autoplayTimeout": 7000, "smartSpeed": 1800, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "3" } , "1000":{ "items" : "<?php echo esc_attr($settings['items_to_display']); ?>" }}}'>

            <?php foreach($settings['testi_v1_repeater'] as $test_block):?>
                    <?php if($settings['testminoal_style'] == 'type_one'): ?>

                    <div class="testimonial_box type_one">
                        <span class="icon-quote"></span>
                        <div class="testimonial_inner">
                            <?php if(!empty($test_block['comment'])): ?>
                            <div class="description">
                                <p><?php echo wp_kses($test_block['comment'] , $allowed_tags); ?> </p>
                            </div>
                            <?php endif; ?>
                            <div class="lower_content clearfix">
                                ...
                                <div class="authour_name">
                                    ...
                                    <h2><?php echo esc_attr($test_block['name']); ?></h2>
                                    <?php endif; ?>
                                    <?php if(!empty($test_block['designation'])): ?>
                                    <h6><?php echo esc_attr($test_block['designation']); ?></h6>
                                    <?php endif; ?>
                                    <p>
                    ...
                    <?php if($settings['testminoal_style'] == 'type_two'): ?>
