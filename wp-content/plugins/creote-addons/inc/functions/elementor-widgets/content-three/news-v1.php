...
<?php if($settings['blog_box_type'] == 'carousel') : ?>
<section class="blog_all_styles owl_new_one carousel <?php if($settings['border_radius_enable'] == 'yes'): ?> border_disable <?php endif; ?>">
 <div class="<?php echo $settings['owl_nav_block'] ?> <?php echo $settings['owl_dots_block'] ?> <?php echo $settings['owl_nav_postion'] ?> theme_carousel owl-theme owl-carousel"
        data-options='{"loop": true, "margin": 30, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 7000, "smartSpeed": 1800, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "3" } , "1000":{ "items" : "<?php echo esc_attr($settings['items_to_display']); ?>" }}}'>
                <?php
                     $args = array(
                        'post_type' => 'post',
                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    <?php if($settings['news_style'] == 'type_one' || $settings['news_style'] == 'type_three') : ?>
                    <div class="news_box <?php echo esc_html($settings['news_style']); ?> clearfix">
                        <div class="news_inner">
                            ...
                            <div class="image_box">
                                ...
                                <?php creote_category(); ?> </div>
                            </div>
                            <?php endif; ?>
                            <div class="content_box">
                            <?php  creote_blog_meta_for_type_one();?>
                            ...
                            <?php endif; ?>
                                ...
                                <div class="bottom_content clearfix">
                                    <div class="continure_reading">
                                        ...
                                        <a href="<?php echo esc_url(get_permalink()); ?>" class="read_more type_one">
                                            <?php echo esc_html($settings['read_more']); ?> <span
                    ...
                    <?php endif;?>
                    <?php if($settings['news_style'] == 'type_two') : ?>
                    ...
                    <div class="news_box type_two">
                        <div class="image_box clearfix ">
                            ...
                            <?php endif; ?>
                            <?php creote_blog_meta_for_type_two(); ?>
                        ...
                        <div class="overlay">
                            ...
                            <div class="bottom_content clearfix">
                                <div class="continure_reading">
                                    <?php if ( 'post' === get_post_type() ) : ?>
                                    <a href="<?php echo esc_url(get_permalink()); ?>" class="read_more type_two">
                                        <?php echo esc_html($settings['read_more']); ?> <span
                                            class="icon-arrow-right"></span></a>
                                    <?php endif; ?>
                                </div>
...
<?php elseif($settings['blog_box_type'] == 'grid') : ?>

<section class="blog_all_styles grid <?php if($settings['border_radius_enable'] == 'yes'): ?> border_disable <?php endif; ?>">
    ...
    <div class="row">
        ...
        <div class="<?php echo esc_attr($settings['column_count']); ?>  col-xs-12">
            <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                <?php if($settings['news_style'] == 'type_one' || $settings['news_style'] == 'type_three') : ?>
                <div class="news_box <?php echo esc_html($settings['news_style']); ?> clearfix">
                    <div class="news_inner">
