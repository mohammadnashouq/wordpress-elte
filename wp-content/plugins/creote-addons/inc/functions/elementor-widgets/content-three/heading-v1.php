...
protected function render(){
    ...
    ?>
<div class="heading  <?php echo $settings['headings_types']; ?> <?php echo $settings['heading_text_alignment']; ?>">
    <?php if(!empty($settings['heading_small_text'])) : ?>
    <div class="small_text">
        <?php if($settings['headings_types'] == 'type_one') : ?>
        <?php if(!empty($settings['heading_icon'])) : ?>
        <span class="<?php echo esc_html($settings['heading_icon']); ?> icon"></span>
        <?php endif; ?>
        <?php endif; ?>
        <?php echo wp_kses($settings['heading_small_text'],  $allowed_tags); ?>
    </div>
    <?php endif; ?>
    <?php if(!empty($settings['heading_main_text'])) : ?>
    <div class="heading_text"><?php echo wp_kses($settings['heading_main_text'],  $allowed_tags);  ?></div>
    <?php endif; ?>
    <?php if($settings['headings_types'] == 'type_two') : ?>
    <div class="small_text_sub"><?php echo wp_kses($settings['heading_small_text'],  $allowed_tags); ?></div>
    <?php endif; ?>
    <?php if(!empty($settings['heading_decription'])) : ?>
    <p class="description_text"><?php echo wp_kses($settings['heading_decription'],  $allowed_tags);  ?></p>
    <?php endif; ?>
