            ...
            'heading_color',
             [
                ...
                'type' => Controls_Manager::COLOR,
                 'selectors' => [
                    '{{WRAPPER}} .icon_box_new_box.type_one h2 a , {{WRAPPER}} .icon_box_new_box.type_two h2 a , {{WRAPPER}} .icon_box_new_box.type_three .content h2 a  ' => 'color: {{VALUE}}!important;',
                  ],
             ]
          );
        ...
        $this->add_control(
            'heading_hover_color',
             [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .icon_box_new_box.type_one h2 a:hover , {{WRAPPER}} .icon_box_new_box.type_two h2 a:hover , {{WRAPPER}} .icon_box_new_box.type_three .content h2:hover a ' => 'color: {{VALUE}}!important;',
                ],
             ]
          );
...
<?php if($settings['icon_box_type'] == 'type_one') : ?>
...
<div class="icon_box_new_box type_one">
    ...
    <div class="text_box">
        ...
        <h2><a  <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>
                href="<?php echo esc_url($settings['link'] ['url']); ?>"><?php echo esc_html($settings['icon_heading_text']); ?></a>
        </h2>
...
<?php if($settings['icon_box_type'] == 'type_three') : ?>
