<?php
   ...
   class Widget_creote_slider_v4 extends Widget_Base
   {
             ...
             $this->add_control(
               'list_item_color',
                [
                   ...
                   'type' => Controls_Manager::COLOR,
                   'selectors' => [
                       '{{WRAPPER}} .slider_version_v4.style_one .slide-item-content .slider_content ul li ' => 'color: {{VALUE}}!important;',
                   ], 
                ]
             );
             $this->add_control(
               'list_item_color_dot',
                [
                   ...
                   'type' => Controls_Manager::COLOR,
                   'selectors' => [
                       '{{WRAPPER}} .slider_version_v4.style_one .slide-item-content .slider_content ul li:before ,
                       {{WRAPPER}} .slider_version_v4.style_one .slide-item-content .slider_content ul li:after  ' => 'background: {{VALUE}}!important;',
                   ], 
                ]
             );
                 ...
                 $this->add_control(
                   'contact_box_icon_color',
                    [
                       ...
                       'type' => Controls_Manager::COLOR,
                        'selectors' => [
                           '{{WRAPPER}} .slider_version_v4 .pr_relative .contact_box_ban .icon_bx span  ' => 'color: {{VALUE}}!important;',
                         ],
                    ]
                 );
                 ...
                 $this->add_control(
                   'contact_box_bg_icon_color',
                    [
                       ...
                       'type' => Controls_Manager::COLOR,
                        'selectors' => [
                           '{{WRAPPER}} .slider_version_v4 .pr_relative .contact_box_ban .icon_bx span  ' => 'background: {{VALUE}}!important;',
                         ],
                    ]
                 );
                 $this->add_control(
                   'contact_heading_title',
                    [
                       ...
                       'type' => Controls_Manager::COLOR,
                        'selectors' => [
                           '{{WRAPPER}} .slider_version_v4 .pr_relative .contact_box_ban .conent_bx h6  ' => 'color: {{VALUE}}!important;',
                         ],
                    ]
                 );
                 $this->add_control(
                   'contact_heading_content',
                    [
                       ...
                       'type' => Controls_Manager::COLOR,
                        'selectors' => [
                           '{{WRAPPER}} .slider_version_v4 .pr_relative .contact_box_ban .conent_bx p  ' => 'color: {{VALUE}}!important;',
                         ],
                    ]
                 );
       ...
       protected function render()
       {
          ...
          ?>
<section class="slider style_one slider_version_v4  <?php echo esc_attr($settings['pag_positions']); ?> <?php echo esc_attr($settings['nav_positions']); ?>">
   <div class="banner-carousel theme_carousel owl-theme owl-carousel" data-options='{"loop": false, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "1" } , "1000":{ "items" : "1" }}}'>
      <?php foreach($settings['v4_slider_repeater'] as $key => $v4_slider_repeater):
         $content_paddings = $v4_slider_repeater['content_padding'];
      ...
      <div class="slide-item">
         <div class="slide-item-content">
            ...
            <div class="image-layer" <?php if(!empty($v4_slider_repeater['slider_background_image']['url'])): ?> style="background-image:url(<?php echo esc_url($v4_slider_repeater['slider_background_image']['url']); ?>)" <?php endif; ?>></div>
               ...
               <div class="contnet_d_flex">
                  <div class="text_box_content">
                     <div class="slider_content" <?php echo $content_paddingscss; ?>>
                        <?php if(!empty($v4_slider_repeater['small_heading_enable'] == 'yes')): ?>
                        <h6  class="animated <?php echo esc_attr($v4_slider_repeater['small_heading_trans']); ?>">
                           <?php echo wp_kses($v4_slider_repeater['small_heading'] , $allowed_tags); ?>
                        </h6>
                        <?php endif; ?>
                        <?php if(!empty($v4_slider_repeater['heading_enable'] == 'yes')): ?>
                        <h1  class="animated <?php echo esc_attr($v4_slider_repeater['heading_trans']); ?>">
                           <?php echo wp_kses($v4_slider_repeater['heading'] , $allowed_tags); ?>
                        </h1>
                        <?php endif; ?>
                        <?php if(!empty($v4_slider_repeater['description_enable'] == 'yes')): ?>
                        <p  class="animated <?php echo esc_attr($v4_slider_repeater['description_trans']); ?>">
                           <?php echo wp_kses($v4_slider_repeater['description'] , $allowed_tags); ?>
                        </p>
                        <?php endif; ?> 
                       
                        <?php if($v4_slider_repeater['button_enable'] == 'yes' || $v4_slider_repeater['tag_enable'] == 'yes'): ?>
                          <ul>
                          <?php if($v4_slider_repeater['button_enable'] == 'yes'): ?>
                        <?php $target = $v4_slider_repeater['button_link']['is_external'] ? ' target="_blank"' : '';
                           $nofollow = $v4_slider_repeater['button_link']['nofollow'] ? ' rel="nofollow"' : ''; ?>
                       <li> <div class="thm_btn  animated <?php echo esc_attr($v4_slider_repeater['button_trans']); ?>">
                           <a href="<?php echo esc_url($v4_slider_repeater['button_link']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?> class="theme-btn one  animated <?php echo esc_attr($v4_slider_repeater['button_trans']); ?>">
                           <?php echo esc_html($v4_slider_repeater['button']); ?>
                           </a>
                        </div> </li>
                        <?php endif; ?>
                        <?php if($v4_slider_repeater['tag_enable'] == 'yes'): ?>
                       <li> <div class="tag_content animated <?php echo esc_attr($v4_slider_repeater['tag_trans']); ?>">
                           <?php echo wp_kses($v4_slider_repeater['tag_content'] , $allowed_tags); ?>
                       </div></li>
                        <?php endif; ?>
                        </ul>
                        <?php endif; ?>
