<?php
   ...
   class Widget_creote_slider_v3 extends Widget_Base
   {
   
       public function get_name()
       {
           return 'creote-slider-v3';
       }
   
       public function get_title()
       {
           return __('Slider V3', 'creote-addons');
       }
       ...
       protected function register_controls(){
         $this->start_controls_section('slider_v3_slect',
         [ 
             'label' => __('Slider V3', 'creote-addons')
         ]
         );
         ...
         $this->end_controls_section();
           ...
           $repeater->add_control(
               'list_enable',
               [
                 'label' => __( 'List Enable', 'creote-addons' ),
                 'type' => Controls_Manager::SWITCHER,
                 'label_on' => __( 'Show', 'creote-addons' ),
                 'label_off' => __( 'Hide', 'creote-addons' ),
                 'return_value' => 'yes',
           ...
           $repeater->add_control(
             'list_text',
             [
                'label' => __('List Text', 'creote-addons'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __('Inspired <br>  Performance', 'creote-addons'),
                'placeholder' => __('Type your text here', 'creote-addons'),    
                'condition' => [
           ...
           $repeater->add_control(
             'list_trans',
             [
               'label' => __( 'List Transition', 'creote-addons' ),
               'type' => \Elementor\Controls_Manager::SELECT,
               'default' => '_fadeInDownBig' ,
               'options' => [
                 '_bounce'  => __( 'Bounce', 'creote-addons' ),
          ...
          $repeater->add_control(
           'slider_image',
           [
             'label' => __( 'Slider Image', 'creote-addons' ),
         ...
         $this->add_control(
           'contact_enable',
           [
             'label' => __( 'Contact Enable', 'creote-addons' ),
             'type' => Controls_Manager::SWITCHER,
             'label_on' => __( 'Show', 'creote-addons' ),
             'label_off' => __( 'Hide', 'creote-addons' ),
             'return_value' => 'yes',
         ...
         $this->add_control(
           ...
           [
               ...
               'default' => __('icon-phone' , 'creote-addons'),
                'condition' => [
                   'contact_enable' => 'yes',
                ]
           ]
         ...
         $this->add_control(
           ...
           $this->start_controls_section('slider_v3_css',
           [ 
             ...
             'small_heading_color',
              [
                 ...
                 'type' => Controls_Manager::COLOR,
                  'selectors' => [
                     '{{WRAPPER}} .slider_version_v3.style_one .slide-item-content .slider_content h6 ' => 'color: {{VALUE}}!important;',
                   ],
              ]
           );
           ...
           $this->add_control(
             'heading_color',
              [
                 ...
                 'type' => Controls_Manager::COLOR,
                  'selectors' => [
                     '{{WRAPPER}} .slider_version_v3.style_one .slide-item-content .slider_content h1  ' => 'color: {{VALUE}}!important;',
                   ],
              ]
           );
             ...
             $this->add_control(
               'description_color',
                [
                   ...
                   'type' => Controls_Manager::COLOR,
                   'selectors' => [
                       '{{WRAPPER}} .slider_version_v3.style_one .slide-item-content .slider_content p ' => 'color: {{VALUE}}!important;',
                   ], 
                ]
             );
             $this->add_control(
               'list_item_color',
                [
                   ...
                   'type' => Controls_Manager::COLOR,
                   'selectors' => [
                       '{{WRAPPER}} .slider_version_v3.style_one .slide-item-content .slider_content ul li ' => 'color: {{VALUE}}!important;',
                   ], 
                ]
             );
             $this->add_control(
               'list_item_color_dot',
                [
                   'label' => __('List Item Dot Color', 'creote-addons'),
                   'type' => Controls_Manager::COLOR,
                   'selectors' => [
                       '{{WRAPPER}} .slider_version_v3.style_one .slide-item-content .slider_content ul li:before ,
                       {{WRAPPER}} .slider_version_v3.style_one .slide-item-content .slider_content ul li:after  ' => 'background: {{VALUE}}!important;',
                   ], 
                ]
             );
             ...
             $this->add_control(
               'button_color',
                [
                   ...
                   'type' => Controls_Manager::COLOR,
                    'selectors' => [
                       '{{WRAPPER}} .slider_version_v3.style_one .slide-item-content .slider_content a.theme-btn  ' => 'color: {{VALUE}}!important;',
                     ],
                ]
             );
               ...
               $this->add_control(
                 'button_bg_color',
                  [
                     ...
                     'type' => Controls_Manager::COLOR,
                     'selectors' => [
                         '{{WRAPPER}} .slider_version_v3.style_one .slide-item-content .slider_content a.theme-btn ' => 'background: {{VALUE}}!important; border-color: {{VALUE}}!important;',
                     ], 
                  ]
               );
               ...
               $this->add_control(
                 'hover_button_color',
                  [
                     ...
                     'type' => Controls_Manager::COLOR,
                      'selectors' => [
                         '{{WRAPPER}} .slider_version_v3.style_one .slide-item-content .slider_content a.theme-btn:hover  ' => 'color: {{VALUE}}!important;',
                       ],
                  ]
               );
                 ...
                 $this->add_control(
                   'hover_button_bg_color',
                    [
                       ...
                       'type' => Controls_Manager::COLOR,
                       'selectors' => [
                           '{{WRAPPER}} .slider_version_v3.style_one .slide-item-content .slider_content a.theme-btn:hover ' => 'background: {{VALUE}}!important; border-color: {{VALUE}}!important;',
                       ], 
                    ]
                 );
                 ...
                 $this->add_control(
                   'contact_box_icon_color',
                    [
                       'label' => __('Icon Color', 'creote-addons'),
                       'type' => Controls_Manager::COLOR,
                        'selectors' => [
                           '{{WRAPPER}} .slider_version_v3 .pr_relative .contact_box_ban .icon_bx span  ' => 'color: {{VALUE}}!important;',
                         ],
                    ]
                 );
   
                 $this->add_control(
                   'contact_box_bg_icon_color',
                    [
                       'label' => __('Icon Color', 'creote-addons'),
                       'type' => Controls_Manager::COLOR,
                        'selectors' => [
                           '{{WRAPPER}} .slider_version_v3 .pr_relative .contact_box_ban .icon_bx span  ' => 'background: {{VALUE}}!important;',
                         ],
                    ]
                 );
                 $this->add_control(
                   'contact_heading_title',
                    [
                       ...
                       'type' => Controls_Manager::COLOR,
                        'selectors' => [
                           '{{WRAPPER}} .slider_version_v3 .pr_relative .contact_box_ban .conent_bx h6  ' => 'color: {{VALUE}}!important;',
                         ],
                    ]
                 );
                 $this->add_control(
                   'contact_heading_content',
                    [
                       'label' => __('Contact Content Color', 'creote-addons'),
                       'type' => Controls_Manager::COLOR,
                        'selectors' => [
                           '{{WRAPPER}} .slider_version_v3 .pr_relative .contact_box_ban .conent_bx p  ' => 'color: {{VALUE}}!important;',
                         ],
                    ]
                 );
       ...
       protected function render()
       {
          ...
          ?>
<section class="slider style_one slider_version_v3  <?php echo esc_attr($settings['pag_positions']); ?> <?php echo esc_attr($settings['nav_positions']); ?>">
               ...
               <div class="contnet_d_flex">
                  <div class="text_box_content">
                     <div class="slider_content" <?php echo $content_paddingscss; ?>>
                        ...
                        <?php endif; ?> 
                        <?php if(!empty($v2_slider_repeater_one['list_enable'] == 'yes')): ?>
                        <?php if(!empty($v2_slider_repeater_one['list_text'])): ?>
                        <ul  class="animated <?php echo esc_attr($v2_slider_repeater_one['list_trans']); ?>">
                           <?php $list_texts = explode("\n", ($v2_slider_repeater_one['list_text']));?>
                           <?php foreach($list_texts as $list_text):?>
                           <li>
                              <?php echo wp_kses($list_text, true); ?>
                           </li>
                           <?php endforeach; ?>
                        </ul>
                        <?php endif; ?>
                        ...
                        <div class="thm_btn animated <?php echo esc_attr($v2_slider_repeater_one['button_trans']); ?>">
                           <a href="<?php echo esc_url($v2_slider_repeater_one['button_link']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?> class="theme-btn two  animated <?php echo esc_attr($v2_slider_repeater_one['button_trans']); ?>">
                  ...
                  <div class="image_content">
                     <?php if(!empty($v2_slider_repeater_one['slider_image']['url'])) :?>
                     <div class="slider_image <?php echo esc_attr($v2_slider_repeater_one['image_trans']); ?>">
                        <img src="<?php  echo esc_url($v2_slider_repeater_one['slider_image']['url']);  ?>" class="img-fluid" alt="<?php esc_attr_e('slider image', 'creote-addons'); ?>"   />
                     </div>
                     <?php endif; ?> 
                  </div>
               </div>
   ...
   <div class="auto-container pr_relative">
      <div class="contact_box_ban">
         <div class="icon_bx">
            <span class="<?php echo esc_attr($settings['icon_fonts']); ?>"></span>
         </div>
         <div class="conent_bx">
            <?php if(!empty($settings['contact_title'])): ?>
            <h6><?php echo wp_kses($settings['contact_title'] , $allowed_tags); ?></h6>
            <?php endif; ?> 
            <?php if(!empty($settings['contact_content'])): ?>
            <p><?php echo wp_kses($settings['contact_content'] , $allowed_tags); ?></p>
            <?php endif; ?> 
         </div>
      </div>
   </div>
...
Plugin::instance()->widgets_manager->register_widget_type(new Widget_creote_slider_v3());