<?php
   ...
   class Widget_creote_slider_v1 extends Widget_Base
   {
           ...
           $repeater->add_control(
             ...
             [
               ...
               'options' => [
                 ...
                 '_flipOutX'  => __( 'flip Out X', 'creote-addons' ),
                 '_flipOutY'  => __( 'flip Out Y', 'creote-addons' ),
   
                 '_lightSpeedInRight'  => __( 'light Speed In Right', 'creote-addons' ),
                 '_lightSpeedInLeft'  => __( 'light Speed In Left', 'creote-addons' ),
                 '_lightSpeedOutRight'  => __( 'light Speed Out tRight', 'creote-addons' ),
                 '_lightSpeedOutLeft'  => __( 'light Speed Out Left', 'creote-addons' ),
      ...
      ?>
<section class="slider <?php echo esc_attr($settings['slider_styles']); ?> <?php echo esc_attr($settings['pag_positions']); ?> <?php echo esc_attr($settings['nav_positions']); ?>">
   <div class="banner-carousel theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 7000, "smartSpeed": 1800, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "1" } , "1000":{ "items" : "1" }}}'>
      <?php if($settings['slider_styles'] == 'style_one'):  // style_one ?>
      <?php foreach($settings['slider_repeater'] as $key => $slider_repeater):
         $image_margin = $slider_repeater['image_margin'];
         $image_margin    = ! empty( $image_margin ) ? "margin: $image_margin;" : '';
         $image_margincss  = "style='$image_margin'";
  
         
         ?>
      <div class="slide-item">
         <div class="slide-item-content <?php echo esc_attr($slider_repeater['content_alginment']); ?>">
            <div class="image-layer" <?php if(!empty($slider_repeater['slider_background_image']['url'])): ?> style="background-image:url(<?php echo esc_url($slider_repeater['slider_background_image']['url']); ?>)" <?php endif; ?>></div>
            <div class="auto-container">
               <div class="row">
                  <div class="col-md-12 col-lg-7 col-sm-12 col-xs-12">
                     <div class="slider_content" <?php if(!empty($slider_repeater['content_padding'])): ?> style="padding:<?php echo esc_attr($slider_repeater['content_padding']); ?>;" <?php endif; ?> >
                        ...
                        <?php endif; ?>
                        <?php if(!empty($slider_repeater['small_heading'])): ?>
                        <h6  class="animated <?php echo esc_attr($slider_repeater['small_heading_trans']); ?>">
                           <?php echo wp_kses($slider_repeater['small_heading'] , $allowed_tags); ?>
                        </h6>
                        <?php endif; ?>
                        <?php if(!empty($slider_repeater['description'])): ?>
                        <p class="description animated <?php echo esc_attr($slider_repeater['description_trans']); ?>">
                           <?php echo wp_kses($slider_repeater['description'] , $allowed_tags); ?>
                        </p>
                        <?php endif; ?>
                        <?php if(!empty($slider_repeater['button'])) :?>
                        <?php $target = $slider_repeater['button_link']['is_external'] ? ' target="_blank"' : '';
                           $nofollow = $slider_repeater['button_link']['nofollow'] ? ' rel="nofollow"' : ''; ?>
                        <a href="<?php echo esc_url($slider_repeater['button_link']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?> class="theme-btn one  animated <?php echo esc_attr($slider_repeater['button_trans']); ?>">
                  ...
                  <div class="col-md-12 col-lg-5 col-sm-12 col-xs-12 image_column">
                     <?php if(!empty($slider_repeater['slider_image']['url'])) :?>
                     <div class="slider_image <?php echo esc_attr($slider_repeater['image_trans']); ?>" <?php echo $image_margincss; ?>>
                        <img src="<?php  echo esc_url($slider_repeater['slider_image']['url']);  ?>" class="img-fluid" alt="<?php esc_attr_e('slider image', 'creote-addons'); ?>" />
                     </div>
                     <?php endif; ?> 
                  </div>
               </div>
      ...
      <?php endforeach;?>
      <?php // style one end  ?>
      <?php elseif($settings['slider_styles'] == 'style_four'):  // style_one ?>
      <?php // style two start  ?>
      <?php foreach($settings['slider_repeater_sttwo'] as $key => $slider_repeater_sttwo):
        
         $content_paddings = $slider_repeater_sttwo['content_padding'];
         $content_paddings    = ! empty( $content_paddings ) ? "padding: $content_paddings;" : '';
         $content_paddingscss  = "style='$content_paddings'";
      ...
      <div class="slide-item-content">
         ...
         <div class="slide-item <?php echo esc_attr($slider_repeater_sttwo['content_alginment']); ?>">
            <div class="image-layer" <?php if(!empty($slider_repeater_sttwo['slider_background_image']['url'])): ?> style="background-image:url(<?php echo esc_url($slider_repeater_sttwo['slider_background_image']['url']); ?>)" <?php endif; ?>></div>
            <div class="auto-container">
               <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                     <div class="slider_content" <?php echo $content_paddingscss; ?>>
                        <?php if(!empty($slider_repeater_sttwo['small_heading'])): ?>
                        <h6  class="animated <?php echo esc_attr($slider_repeater_sttwo['small_heading_trans']); ?>">
                           <?php echo wp_kses($slider_repeater_sttwo['small_heading'] , $allowed_tags); ?>
                        </h6>
                        <?php endif; ?>
                        <?php if(!empty($slider_repeater_sttwo['heading'])): ?>
                        <h1  class="animated <?php echo esc_attr($slider_repeater_sttwo['heading_trans']); ?>">
                           <?php echo wp_kses($slider_repeater_sttwo['heading'] , $allowed_tags); ?>
                        </h1>
                        <?php endif; ?>
                        <?php if(!empty($slider_repeater_sttwo['description'])): ?>
                        <p class="description animated <?php echo esc_attr($slider_repeater_sttwo['description_trans']); ?>">
                           <?php echo wp_kses($slider_repeater_sttwo['description'] , $allowed_tags); ?>
                        </p>
                        <?php endif; ?>
                        <?php if(!empty($slider_repeater_sttwo['button'])) :?>
                        <?php $target = $slider_repeater_sttwo['button_link']['is_external'] ? ' target="_blank"' : '';
                           $nofollow = $slider_repeater_sttwo['button_link']['nofollow'] ? ' rel="nofollow"' : ''; ?>
                        <a href="<?php echo esc_url($slider_repeater_sttwo['button_link']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?> class="theme-btn one  animated <?php echo esc_attr($slider_repeater_sttwo['button_trans']); ?>">
                        <?php echo esc_html($slider_repeater_sttwo['button']); ?>
                        </a>
                        <?php endif; ?>
                     </div>
                  </div>
      ...
      <?php endforeach;?>
      <?php // slider style two end ?>
      <?php elseif($settings['slider_styles'] == 'style_three'):  // style_one ?>
      <?php // slider style three start ?>
      <?php foreach($settings['slider_repeater_three'] as  $key => $slider_repeater_three):
         $content_paddings = $slider_repeater_three['content_paddings'];
         $content_paddings    = ! empty( $content_paddings ) ? "padding: $content_paddings;" : '';
         $content_paddingscss  = "style='$content_paddings'";
         ?>
      <div class="slide-item">
      <div class="slide-item-content <?php echo esc_attr($slider_repeater_three['content_alginment']); ?>">
         <div class="image-layer" <?php if(!empty($slider_repeater_three['slider_background_image']['url'])): ?> style="background-image:url(<?php echo esc_url($slider_repeater_three['slider_background_image']['url']); ?>)" <?php endif; ?>></div>
         <div class="auto-container">
            <div class="row">
               <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                  <div class="slider_content" <?php echo __($content_paddingscss); ?>>
                     <?php if(!empty($slider_repeater_three['heading'])): ?>
                     <h1  class="animated <?php echo esc_attr($slider_repeater_three['heading_trans']); ?>">
                        <?php echo wp_kses($slider_repeater_three['heading'] , $allowed_tags); ?>
                     </h1>
                     <?php endif; ?>
                     <?php if(!empty($slider_repeater_three['description'])): ?>
                     <p  class="animated <?php echo esc_attr($slider_repeater_three['description_trans']); ?>">
                        <?php echo wp_kses($slider_repeater_three['description'] , $allowed_tags); ?>
                     </p>
                     <?php endif; ?> 
                     <ul>
                        <?php if(!empty($slider_repeater_three['button'])) :?>
                        <?php $target = $slider_repeater_three['button_link']['is_external'] ? ' target="_blank"' : '';
                           $nofollow = $slider_repeater_three['button_link']['nofollow'] ? ' rel="nofollow"' : ''; ?>
                        <li>
                           <a href="<?php echo esc_url($slider_repeater_three['button_link']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?> class="theme-btn five  animated <?php echo esc_attr($slider_repeater_three['button_trans']); ?>">
                           <?php echo esc_html($slider_repeater_three['button']); ?>
                           </a>
                        </li>
                        <?php endif; ?>
                        <?php if(!empty($slider_repeater_three['video_link'])): ?>
                        <li>
                           <div class="video_box animated <?php echo esc_attr($slider_repeater_three['video_trans']); ?>">
                              <a href="<?php echo esc_attr($slider_repeater_three['video_link']); ?>" class="lightbox-image"><i class="icon-play"></i></a>
                           </div>
                        </li>
                        <?php endif; ?>
                     </ul>
      ...
      <?php endforeach;?>
      <?php // slider style three End ?>
      <?php elseif($settings['slider_styles'] == 'style_two'):  // style_one ?>
      <?php // style two start  ?>
      <?php foreach($settings['slider_repeater_four'] as  $key => $slider_repeater_four):
         $image_margin = $slider_repeater_four['image_margin'];
         $image_margin    = ! empty( $image_margin ) ? "margin: $image_margin;" : '';
         $image_margincss  = "style='$image_margin'";
         $content_paddings = $slider_repeater_four['content_paddings'];
         $content_paddings    = ! empty( $content_paddings ) ? "padding: $content_paddings;" : '';
         $content_paddingscss  = "style='$content_paddings'";
         ?>
     <div class="slide-item">
      <div class="slide-item-content <?php echo esc_attr($slider_repeater_four['content_alginment']); ?>">
         <div class="image-layer" <?php if(!empty($slider_repeater_four['slider_background_image']['url'])): ?> style="background-image:url(<?php echo esc_url($slider_repeater_four['slider_background_image']['url']); ?>)" <?php endif; ?>></div>
         <div class="auto-container">
            <div class="row">
               <div class="col-md-12 col-lg-7 col-sm-12 col-xs-12">
                  <div class="slider_content" <?php echo $content_paddingscss; ?>>
                     <?php if(!empty($slider_repeater_four['heading'])): ?>
                     <h1  class="animated <?php echo esc_attr($slider_repeater_four['heading_trans']); ?>">
                        <?php echo wp_kses($slider_repeater_four['heading'] , $allowed_tags); ?>
                     </h1>
                     <?php endif; ?>
                     <?php if(!empty($slider_repeater_four['description'])): ?>
                     <p  class="animated <?php echo esc_attr($slider_repeater_four['description_trans']); ?>">
                        <?php echo wp_kses($slider_repeater_four['description'] , $allowed_tags); ?>
                     </p>
                     <?php endif; ?> 
                     <ul>
                        <?php if(!empty($slider_repeater_four['button'])) :?>
                        <?php $target = $slider_repeater_four['button_link']['is_external'] ? ' target="_blank"' : '';
                           $nofollow = $slider_repeater_four['button_link']['nofollow'] ? ' rel="nofollow"' : ''; ?>
                        <li>
                           <a href="<?php echo esc_url($slider_repeater_four['button_link']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?> class="theme-btn three  animated <?php echo esc_attr($slider_repeater_four['button_trans']); ?>">
                           <?php echo esc_html($slider_repeater_four['button']); ?>
                           </a>
                        </li>
                        <?php endif; ?>
                        <?php if(!empty($slider_repeater_four['video_link'])): ?>
                        <li>
                           <div class="video_box animated <?php echo esc_attr($slider_repeater_four['video_trans']); ?>">
                              <a href="<?php echo esc_attr($slider_repeater_four['video_link']); ?>" class="lightbox-image"><i class="icon-play"></i></a>
                           </div>
                        </li>
                        <?php endif; ?>
                     </ul>
               ...
               <div class="col-md-12 col-lg-5 col-sm-12 col-xs-12 image_column">
                  <?php if(!empty($slider_repeater_four['slider_image']['url'])) :?>
                  <div class="slider_image <?php echo esc_attr($slider_repeater_four['image_trans']); ?>" <?php echo $image_margincss; ?>>
                     <img src="<?php  echo esc_url($slider_repeater_four['slider_image']['url']);  ?>" class="img-fluid" alt="<?php esc_attr_e('slider image', 'creote-addons'); ?>" />
                  </div>
                  <?php endif; ?> 
               </div>
            </div>
