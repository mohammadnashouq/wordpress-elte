...
protected function render() {
  ...
  ?>
<section class="contact_form_box_all <?php echo esc_attr($settings['contact_style']); ?>"
  <?php if($settings['transitions_enable'] == 'yes'):  ?> data-aos="fade-up"  data-aos-offset="0"
  data-aos-delay="<?php echo esc_html($settings['transitions']); ?>" <?php endif;?>>
  <?php if($settings['contact_style'] == 'type_one'): ?>
  <div class="contact_form_box_inner">
    <div class="contact_form_shortcode">
      <?php if(!empty($settings['contact_form_url'])): ?>
      <?php echo do_shortcode('[contact-form-7 id="'.$settings['contact_form_url'].'"]'); ?>
      <?php else: ?>
      <p><?php echo esc_html('There is no contact form please create it' , 'creote-addons'); ?></p>
      <?php endif; ?>
    </div>
  </div>
  <?php elseif($settings['contact_style'] == 'type_two'): ?>
  <div class="contact_form_box_inner">
    ...
    <div class="contact_form_shortcode">
      ...
      <div class="heading">
        <h2><?php echo wp_kses($settings['contact_heading'] , $allowed_tags); ?></h2>
      </div>
      <?php endif; ?>
      <div class="_form">
        <?php if(!empty($settings['contact_form_url'])): ?>
        <?php echo do_shortcode('[contact-form-7 id="' . $settings['contact_form_url'] . '"]'); ?>
        <?php elseif(empty($settings['contact_form_url'])): ?>
        <p><?php echo esc_html('There is no contact form please create it' , 'creote-addons'); ?></p>
        <?php endif; ?>
      </div>
    </div>
  </div>
  <?php elseif($settings['contact_style'] == 'type_three'): ?>
