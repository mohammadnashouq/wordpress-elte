<?php
   ...
   class Widget_creote_link_box_v1 extends Widget_Base
   {
       ...
       protected function render() {
   		...
   		?>
<div class="link_box_contents  <?php echo esc_attr($settings['link_box_styles']); ?>" <?php if($settings['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($settings['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
   <?php if($settings['link_box_styles'] == 'style_one'): ?>
   <div class="link_content_bx">
      ...
      <div class="con_box">
         ...
         <a href="<?php echo esc_url($settings['read_link']['url']);?>"  <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>><?php echo wp_kses($settings['link_text'] , $allowed_tags); ?> <i class="icon-right-arrow-long"></i></a>
      </div>
   </div>
   <?php endif; ?>
   <?php if($settings['link_box_styles'] == 'style_two'): ?>
   <div class="link_content_bx">
      <div class="con_box">
         <h2><?php echo wp_kses($settings['heading'] , $allowed_tags); ?></h2>
         <a href="<?php echo esc_url($settings['read_link']['url']);?>"  <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>><?php echo wp_kses($settings['link_text'] , $allowed_tags); ?> <i class="icon-right-arrow-long"></i></a>
