...
class Widget_creote_content_box_v1 extends Widget_Base
{
    ...
    protected function register_controls() {
        ...
        $this->add_control(
			'content_box_styles',
			[
				'label'   => esc_html__( 'Content Box Style', 'creote-addons' ),
...
<div class="content_box_cn  <?php echo esc_attr($settings['content_box_styles']); ?>"
    ...
    <?php // style one ?>
    <?php if($settings['content_box_styles'] == 'style_one'): ?>
    <?php // style one ?>
    <div class="txt_content">
        <?php if(!empty($settings['content_box_heading'])):?>
        <h3>
            <a href="<?php echo esc_url($settings['link_box']['url']); ?>" <?php echo esc_attr($target); ?>
    ...
    <?php // style one ?>
    <?php elseif($settings['content_box_styles'] == 'style_two'): ?>
    <?php // style one ?>
    <?php // style end ?>
    <?php endif; ?>
    <?php // style end ?>
