<?php
   ...
   class Widget_creote_progress_v1 extends Widget_Base
   {
       ...
       protected function render()
       {
           ...
           ?> 
<?php if($settings['progress_type'] == 'type_one'): ?>
<div class="progress_bar" <?php if($settings['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($settings['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
   <h2><?php echo esc_attr($settings['heading']); ?> <span><?php echo esc_attr($settings['percentage']); ?><?php echo esc_html('%' , 'creote-addons'); ?></span></h2>
   <div class="bar">
      <div class="bar-inner count-bar" data-percent="<?php echo esc_attr($settings['percentage']); ?>%"></div>
   </div>
</div>
<?php elseif($settings['progress_type'] == 'type_two'): ?>
<div class="progress_bar style_two" <?php if($settings['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($settings['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
   <div class="progress_new">
      <div class="ProgressBar ProgressBar--animateText" data-progress="<?php echo esc_attr($settings['percentage']); ?>">
      ...
      <div class="progress-value">
         <div>
            <h6><?php echo esc_attr($settings['extra_content']); ?> </h6>
         </div>
      </div>
   </div>
   <div class="content_box">
      <h2><?php echo esc_attr($settings['percentage']); ?><?php echo esc_html('%' , 'creote-addons'); ?></h2>
      <h3><?php echo esc_attr($settings['heading']); ?> </h3>
      <p><?php echo esc_attr($settings['description']); ?> </p>
   </div>
</div>
<?php elseif($settings['progress_type'] == 'type_three'): ?>
<div class="progress_bar style_three" <?php if($settings['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($settings['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
   <h2><?php echo esc_attr($settings['heading']); ?> <span><?php echo esc_attr($settings['percentage']); ?><?php echo esc_html('%' , 'creote-addons'); ?></span></h2>
   <div class="bar">
      <div class="bar-inner count-bar" data-percent="<?php echo esc_attr($settings['percentage']); ?>%"></div>
   </div>
</div>
<?php elseif($settings['progress_type'] == 'type_four'): ?>
<div class="progress_bar style_four <?php echo esc_attr($settings['color_type']); ?>" <?php if($settings['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($settings['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
   <div class="progress_new">
      <div class="ProgressBar ProgressBar--animateText" data-progress="<?php echo esc_attr($settings['percentage']); ?>">
         <svg class="ProgressBar-contentCircle" height="140" width="140">
            <circle  class="ProgressBar-background" cx="70" cy="70" r="60" />
            <circle transform="rotate(-90, 70, 70)"   class="ProgressBar-circle" cx="70" cy="70" r="60" />
         </svg>
      </div>
      <div class="progress-value">
         <h6><?php echo esc_attr($settings['percentage']); ?><?php echo esc_html('%' , 'creote-addons'); ?></h6>
      </div>
   </div>
   <div class="content_box">
