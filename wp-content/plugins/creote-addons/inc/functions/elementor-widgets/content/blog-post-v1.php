<?php
   ...
   class Widget_creote_blog_post_grid_v1 extends Widget_Base
   {
       ...
       protected function render()
       {
           ...
           $css_classes = '';
             ...
             elseif( $settings['news_column'] == 'three_column'){
   ...
   ?>
<section class="blog_post_section  elemen_wp   <?php echo esc_attr($css_classes); ?> <?php echo esc_attr($settings['news_styles']); ?> <?php if($settings['masonory_enable'] == 'yes'): ?> masonary_enable <?php endif; ?>">
   <div class="grid_show_case grid_layout clearfix">
      ...
      <?php $paged = ( get_query_var('paged') ) ? get_query_var('paged') : 1;
         ...
         if( $settings['query_category'] ) $args['category_name'] = $settings['query_category'];
      ...
      <?php $blog_grid_query->the_post();
         ...
         ?>
      <?php if($settings['news_styles'] == 'style_one'): ?>
      <div class="grid_box _card">
         <div class="news_box style_one blog_classic <?php if(has_post_thumbnail()): ?>has_images<?php else: ?>no_images<?php endif; ?>" id="post-<?php esc_attr(the_ID()); ?>">
            <?php if(has_post_thumbnail()): ?>
            <div class="image img_hover-1">
               <?php the_post_thumbnail($image_size); ?>
               <a class="arrow" href="<?php echo esc_url(get_permalink()); ?>"><i class="fa fa-angle-right"></i></a>
            </div>
            <?php endif;?>    
      ...
      <?php elseif($settings['news_styles'] == 'style_two'): ?>
      <div class="grid_box _card">
         <div class="news_box default_style   list_view <?php if($settings['normal_view'] == 'yes'): ?>   normal_view <?php endif; ?>  <?php if(has_post_thumbnail()): ?>has_images<?php else: ?>no_images<?php endif; ?>" id="post-<?php esc_attr(the_ID()); ?>">
            <?php if(has_post_thumbnail()): ?>
            <div class="image img_hover-1">
            ...
            <div class="content_box">
               ...
               <div class="source">
                  ...
                  <?php endif; ?>
                  <a href="<?php echo esc_url(get_permalink()); ?>" class="link__go"><?php echo esc_attr($settings['button_text']);?></a>
               </div>
               <div class="auhtour_box">
                  <?php echo get_avatar( get_the_author_meta( 'ID' ) , 60 ); ?>
                  <div class="contnet_a">
                     <p><?php echo esc_html__('POSTED BY' , 'creote-addons'); ?></p>
                     <h4>
                        <?php the_author(); ?>
                     </h4>
                  </div>
      ...
      <?php elseif($settings['news_styles'] == 'style_three'): ?>
      <div class="news_box style_two grid_box _card  <?php if(has_post_thumbnail()): ?>has_images<?php else: ?>no_images<?php endif; ?>" id="post-<?php esc_attr(the_ID()); ?>">
         <div class="content_box">
      ...
      <?php elseif($settings['news_styles'] == 'style_four'): ?>
      <div class="grid_box _card style_man">
         <div class="news_box  style_four <?php if($settings['border_radius_enable'] == 'yes'): ?>no_radius<?php endif; ?>  <?php if(has_post_thumbnail()): ?>has_images<?php else: ?>no_images<?php endif; ?>" id="post-<?php esc_attr(the_ID()); ?>"  
            <?php if(has_post_thumbnail()): ?>
      ...
      <?php elseif($settings['news_styles'] == 'style_five'): ?>
      <div class="grid_box _card">
         <div class="news_box style_five">
            <div class="content_box">
               <ul>
                  ...
                  <li>
                     <a href="#"><span class="fa fa-clock-o"></span><?php echo esc_attr(get_the_date(get_option('date_format'))); ?></a>
                  </li>
               </ul>
               <?php the_title( '<h2 class="title"><a href="' .  esc_url(get_permalink()) . '" rel="bookmark">', '</a></h2>' ); ?>
               ...
               <?php if(!empty($myexcerpt)):?>
                  <p class="short_desc"><?php echo  esc_html($myexcerpt); ?></p>
               <?php endif; ?>
               <a href="<?php echo esc_url(get_permalink()); ?>" class="link__go"><?php echo esc_attr($settings['button_text']);?><i class="icon-right-arrow-long"></i></a>
            </div>
         </div>
      </div>
      <?php elseif($settings['news_styles'] == 'style_six'): ?>
      <div class="news_box style_six grid_box _card   <?php if(has_post_thumbnail()): ?>has_images<?php else: ?>no_images<?php endif; ?>" id="post-<?php esc_attr(the_ID()); ?>">
         <div class="content_box">
            <div class="overlay"> </div>
            <?php if(has_post_thumbnail()): ?>
            <?php the_post_thumbnail(); ?>
      ...
      <?php elseif($settings['news_styles'] == 'style_seven'): ?>
      <div class="grid_box _card">
         <div class="news_box style_seven">
            ...
            <div class="content_box ">
               <ul>
                  ...
                  <li><?php creote_comments(); ?></li>
               </ul>
               <?php the_title( '<h2 class="title"><a href="' .  esc_url(get_permalink()) . '" rel="bookmark">', '</a></h2>' ); ?>
               <?php if(!empty($myexcerpt)):?>
                  <p class="short_desc"><?php echo  esc_html($myexcerpt); ?></p>
               <?php endif; ?>
               <a href="<?php echo esc_url(get_permalink()); ?>" class="read_more "><?php echo esc_attr($settings['button_text']);?><i class="icon-right-arrow-long"></i></a>
            </div>
         </div>
      </div>
      <?php elseif($settings['news_styles'] == 'style_eight'): ?>
      <div class="grid_box _card">
      ...
      <?php elseif($settings['news_styles'] == 'style_nine'): ?>
      <div class="grid_box _card">
         <div class="news_box style_nine">
            <div class="content_box">
               <div class="date">
                  <span class="date_in_number"><?php echo esc_attr(get_the_date('d')); ?></span>
                  <span class="date_in_month"><?php echo esc_attr(get_the_date('M')); ?></span>
               </div>
               <div class="content_bx_in">
                  <div class="category">
                     <?php creote_category(); ?>
                  </div>
                  <?php the_title( '<h2 class="title"><a href="' .  esc_url(get_permalink()) . '" rel="bookmark">', '</a></h2>' ); ?>
      ...
      <?php elseif($settings['news_styles'] == 'style_ten'): ?>
      <div class="grid_box _card">
         ...
         <?php if(has_post_thumbnail()): ?>
            ...
            <?php endif;?> 
            <?php the_title( '<h2 class="title"><a href="' .  esc_url(get_permalink()) . '" rel="bookmark">', '</a></h2>' ); ?>
            <ul>  <li class="cag"> <?php creote_category(); ?> </li><li class="dte"><i class="icon-clock"></i><?php echo esc_attr(get_the_date(get_option('date_format'))); ?></li>
       </ul>
         </div>
      </div>
      <?php endif; ?>
