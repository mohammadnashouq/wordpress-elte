       ...
       protected function render()
       {
           ...
           elseif($settings['client_logo_style'] == 'type_three'){
               $client_swipre = 'client_logo_swiper_three';
                 ...
                 ?>
<section class="client_logo_carousel <?php echo esc_attr($settings['client_logo_style']); ?>">
   <div class="swiper-container  <?php echo esc_attr($client_swipre); ?>">
      <div class="swiper-wrapper">
         <?php if($settings['client_logo_style'] == 'type_one'):?>
         <?php foreach($settings['client_logo_repeater'] as $brandimage): 
            $image_width = $brandimage['image_width'];
            $image_width    = ! empty( $image_width ) ? "width: $image_width!important;" : '';
            $margin_top = $brandimage['margin_top'];
            $margin_top    = ! empty( $margin_top ) ? "margin-top: $margin_top!important;" : '';
            $margin_bottom = $brandimage['margin_bottom'];
            $margin_bottom    = ! empty( $margin_bottom ) ? "margin-bottom: $margin_bottom!important;" : '';
            
            
            $image_width_css  = "style='$image_width $margin_top $margin_bottom'";
            
            ?>
         <div class="swiper-slide">
            <div class="image">
               <img src="<?php echo esc_url($brandimage['brandimage']['url']); ?>"  alt="clients-logo" <?php echo $image_width_css; ?>  />
            </div>
         </div>
         <?php endforeach;?>
         <?php elseif($settings['client_logo_style'] == 'type_two'):?>
         <?php foreach($settings['client_logo_repeater'] as $brandimage): 
            $image_width = $brandimage['image_width'];
            $image_width    = ! empty( $image_width ) ? "width: $image_width!important;" : '';
            $margin_top = $brandimage['margin_top'];
         ...
         <?php endforeach;?>
         <?php elseif($settings['client_logo_style'] == 'type_three'):?>
         <?php foreach($settings['client_logo_repeater'] as $brandimage): 
            $image_width = $brandimage['image_width'];
            $image_width    = ! empty( $image_width ) ? "width: $image_width!important;" : '';
            $margin_top = $brandimage['margin_top'];
      ...
      <?php if($settings['pagination_enable'] == 'yes'): ?>
