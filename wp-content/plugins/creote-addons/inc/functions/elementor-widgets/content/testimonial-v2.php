<?php
   ...
   ?>
<div class="testimonial_sec  <?php echo esc_attr($settings['testimonial_styles']); ?>">
 
   <div class="swiper-container swiper_single">
      <div class="swiper-wrapper">
      <?php if($settings['testimonial_styles'] == 'style_v2_one'): ?>
         <?php foreach($settings['testimonial_repeater_c'] as  $testimonial_repeater_c):?>
         <div class="swiper-slide">
            <div class="testimonial_box clearfix">
               <?php if(!empty($testimonial_repeater_c['content_image'])): ?>
               <div class="image"> 
                  <img src="<?php echo esc_url($testimonial_repeater_c['content_image']['url']); ?>" alt="image" />
               </div>
               <?php endif; ?>
               <div class="authour_details">
                  <?php if(!empty($testimonial_repeater_c['brand_image'])): ?>
                  <div class="b_image"> 
                     <img src="<?php echo esc_url($testimonial_repeater_c['brand_image']['url']); ?>" alt="image" />
                  </div>
                  <?php endif; ?>
                  <div class="comment">
         ...
         <?php endforeach;?>
         <?php elseif($settings['testimonial_styles'] == 'style_v2_two'): ?>
         <?php foreach($settings['testimonial_repeater_c_two'] as  $testimonial_repeater_c_two):?>
         <div class="swiper-slide">
            <div class="testimonial_box clearfix">
               
               <div class="authour_details">
                    <?php if(!empty($testimonial_repeater_c_two['client_image'])): ?>
                     <div class="c_image"> 
                        <img src="<?php echo esc_url($testimonial_repeater_c_two['client_image']['url']); ?>" alt="image" />
                     </div>
                     <?php endif; ?>
                  <div class="comment">
                     <?php echo wp_kses($testimonial_repeater_c_two['comment'] , $allowed_tags); ?>
                  </div>
                  <div class="details clearfix">
                    
                     <div class="c_content">
                        <div class="content_in">
                           <h2><?php echo esc_attr($testimonial_repeater_c_two['name']); ?></h2>
                           <span><?php echo esc_attr($testimonial_repeater_c_two['designation']); ?></span>
                        </div>
                     </div>
                  </div>
                  <div class="rating">
                     <ul>
                        <?php if($testimonial_repeater_c_two['rating_one'] == 'one'): ?>
                        <li><span class="fa fa-star fill"></span><span class="fa fa-star empty"></span><span class="fa fa-star empty"></span><span class="fa fa-star empty"></span><span class="fa fa-star empty"></span></li>
                        <?php elseif($testimonial_repeater_c_two['rating_one'] == 'two'): ?>
                        <li><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span><span class="fa fa-star empty"></span><span class="fa fa-star empty"></span><span class="fa fa-star empty"></span></li>
                        <?php elseif($testimonial_repeater_c_two['rating_one'] == 'three'): ?>
                        <li><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span><span class="fa fa-star empty"></span><span class="fa fa-star empty"></span></li>
                        <?php elseif($testimonial_repeater_c_two['rating_one'] == 'four'): ?>
                        <li><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span><span class="fa fa-star empty"></span></li>
                        <?php elseif($testimonial_repeater_c_two['rating_one'] == 'five'): ?>
                        <li><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span></li>
                        <?php else: ?>
                        <li><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span><span class="fa fa-star fill"></span></li>
                        <?php endif; ?>
