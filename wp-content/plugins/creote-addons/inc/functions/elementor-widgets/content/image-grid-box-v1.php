...
?>
<section class="image_grid_content <?php echo esc_attr($settings['image_box_styles']); ?> <?php if($settings['object_fit_cover'] == 'yes'): ?> image_covered <?php endif; ?>">
   <div class="row">
      <?php foreach($settings['image_carousel_repeater'] as $key => $image_carousel_repeater): 
         ...
         ?>
      <div class="<?php echo esc_attr($settings['column_size']); ?>">
         <?php // style one ?>
         <?php if($settings['image_box_styles'] == 'style_one' || $settings['image_box_styles'] == 'style_two'):?>
         <div class="mg_image_box">
            ...
            <?php if(!empty($image_carousel_repeater['title'])): ?>
            <h3>  <a href="<?php echo esc_url($image_carousel_repeater['link']['url']);?>"  <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>>
               <?php echo wp_kses($image_carousel_repeater['title']  ,$allowed_tags); ?>     </a> 
            </h3>
            <?php endif; ?>
            <?php endif; ?>
