...
<div class="quotes_box style_one" <?php if($settings['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($settings['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
   <?php if($settings['icon_type'] == 'icon_image_enable'): ?>
   <div class="icon">
      <img src="<?php echo esc_url($settings['icon_image']['url']); ?>" class="svg_image" alt="<?php esc_attr_e('icon png', 'creote-addons'); ?>" />
   </div>
   <?php elseif($settings['icon_type'] == 'icon_fonts_enable'): ?>
   <div class="icon">
   ...
   <div class="content">
      ...
      <h6><?php echo wp_kses($settings['description'] , $allowed_tags); ?></h6>
      <?php endif; ?>
      <?php if(!empty($settings['authour_name'])): ?>
      <h3><?php echo wp_kses($settings['authour_name'] , $allowed_tags); ?></h3>
      <?php endif; ?>
   </div>
</div>
<?php elseif($settings['quotes_style'] == 'style_two'): ?>
<div class="quotes_box style_two" <?php if($settings['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($settings['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
   <div class="top_content">
      <?php if(!empty($settings['authour_image'])): ?>
      <div class="auth_img">
         <img src="<?php echo esc_url($settings['authour_image']['url']); ?>" class="auth_img" alt="<?php esc_attr_e('authour png', 'creote-addons'); ?>" />
      </div>
      <?php endif; ?>
   ...
   <div class="content">
      ...
      <h3><?php echo wp_kses($settings['authour_name'] , $allowed_tags); ?></h3>
      <?php endif; ?>
      <?php if(!empty($settings['authour_designation'])): ?>
      <h6><?php echo wp_kses($settings['authour_designation'] , $allowed_tags); ?></h6>
      <?php endif; ?>
   </div>
</div>
<?php endif; ?>
