<?php
   ...
   class Widget_creote_product_post_grid_v1 extends Widget_Base
   {
       ...
       protected function render()
       {
           ...
           elseif( $settings['product_column'] == 'three_column'){
   ...
   ?>
<section
   class="product_shop_section  elemen_wp   <?php echo esc_attr($css_classes); ?> <?php echo esc_attr($settings['product_styles']); ?>">
   <div class="full_box">
  ...
  $paged = 1; 
         ...
         if( $settings['query_category'] ) $args['product_cat'] = $settings['query_category'];
         
          $product_grid_query = new \WP_Query( $args ); 
         
         ?>
      <?php while ($product_grid_query->have_posts()) : ?>
      <?php $product_grid_query->the_post();
         global $product;
         ...
         ?>
      <?php if($settings['product_styles'] == 'style_one'): ?>
      <div <?php wc_product_class( 'project-wrapper grid_box', $product ); ?>>
         <div class="product_box type_one">
            <div class="inner_box">
               ...
               <div class="overlay">
                  <ul>
                     <li class="upper_box">
                        <a href="<?php echo esc_attr($product->get_id()); ?>" class="creote_quick_view_btn">
                           <i class="icon-eye"></i>
                        </a>
                     </li>
            ...
            <div class="content_box">
               ...
               <div class="cart_btn">
               <a href="<?php echo esc_attr($product->get_id()); ?>" class="creote_quick_view_btn">
                        <?php echo esc_html__('Quick View' , 'creote-addons') ?>
                     </a>
      ...
      <?php elseif($settings['product_styles'] == 'style_two'): ?>
      <div <?php wc_product_class( 'project-wrapper grid_box', $product ); ?>>
         <div class="product_box type_two">
            <div class="inner_box">
               <?php woocommerce_show_product_sale_flash(); ?>
               <div class="image_box">
                  <?php woocommerce_template_loop_product_thumbnail()?>
      ...
      <?php elseif($settings['product_styles'] == 'style_three'): ?>
      <div <?php wc_product_class( 'project-wrapper grid_box', $product ); ?>>
      ...
      <?php elseif($settings['product_styles'] == 'style_four'): ?>
         <div <?php wc_product_class( 'project-wrapper grid_box', $product ); ?>>
            <div class="product_box type_four">
               <div class="inner_box">
                  <div class="image_box">
                     <?php woocommerce_template_loop_product_thumbnail()?>
                     <div class="overlay">
                        ...
                        <div class="cart_btn">
                           <?php creote_add_to_cart_button_woocommerce();  ?>
                        </div>
                     </div>
                  </div>
                  <div class="content_box">
      ...
      <div class="row">
         <div class="col-lg-12">
            ...
            <?php
               global $wp_query;
               $product_grid_query = !empty($product_grid_query) ? $product_grid_query : $wp_query;
       
               if ($product_grid_query->max_num_pages > 1) {
               ...
               $items =  paginate_links( array(
                    ...
                    'prev_next' => TRUE,
                    'current' => max(0, $paged),
                    'total' => $product_grid_query->max_num_pages,
                    'type' => 'array',
                    'prev_text' => '<i class="fa fa-angle-left"></i>',
                    'next_text' => '<i class="fa fa-angle-right"></i>',
                    'add_args' => false
               ) );
               $pagination_output = "<div class=\"col-sm-12 text-center\"><div class=\"ic-pagination\"><ul><li>";
               $pagination_output .= join("</li><li>", (array)$items);
               $pagination_output .= "</li></ul></div></div>";
