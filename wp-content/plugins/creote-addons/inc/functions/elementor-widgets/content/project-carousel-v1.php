<?php
   ...
   class Widget_creote_project_carousel_v1 extends Widget_Base
   {
       ...
       protected function render()
       {
           ...
           elseif($settings['project_styles'] == 'style_three'){
               $swiper_class = esc_html('swipe_four_nocenter' , 'creote-addons');
           } 
         
   ?>
<section class="project_caro_section carousel <?php echo esc_attr($settings['project_styles']); ?> <?php echo esc_attr($settings['dark_white']); ?>">
   <div class="swiper-container  <?php echo esc_attr($swiper_class); ?>">
      <div class="swiper-wrapper">
         ...
         <?php $project_caro_query->the_post();
            ...
            ?>
         <?php if($settings['project_styles'] == 'style_one' || $settings['project_styles'] == 'style_four'): ?>
         <div class="swiper-slide">
            <div class="project_post style_one <?php if($settings['project_styles'] == 'style_four'): ?> style_four_caro<?php endif; ?>">
               ...
               <div class="project_caro_content">
                  <div class="left_side">
                     ...
                     <p><?php echo esc_attr_e(implode( ', ', (array)$term_list ));?></p>
                     <?php endif; ?>
         ...
         <?php elseif($settings['project_styles'] == 'style_two'): ?>
         <div class="swiper-slide">
            <div class="project_post style_seven">
               ...
               <div class="overlay ">
                  <div class="text ">
                     ...
                     <?php } ?> 
                     <a href="<?php echo esc_url(get_permalink()); ?>" class="read_more tp_five "><?php echo esc_html__($settings['read_more']); ?></a>
                  </div>
               </div>
            </div>
         </div>
         <?php elseif($settings['project_styles'] == 'style_three'): ?>
         <div class="swiper-slide">
