<?php
   ...
   ?>
<section class="service_caro_section carousel <?php echo esc_attr($settings['service_styles']); ?>">
   <div class="swiper-container  swipe_four_nocenter">
      <div class="swiper-wrapper">
         ...
         <?php
            ...
            if( $settings['query_category'] ) $args['service_category'] = $settings['query_category'];
             ...
             $service_caro_query = new \WP_Query( $args ); 
            
            ?>
         <?php while ($service_caro_query->have_posts()) : ?>
         <?php $service_caro_query->the_post();  
        ...
        // style one
         if($settings['service_styles'] == 'style_one'): ?>
                ...
                <div class="service_carousel style_one">
                    ...
                    <?php if(has_post_thumbnail()): ?>
                        <div class="image">
                            ...
                            <?php the_post_thumbnail('creote-service-image'); ?>
                        </div>
                    <?php endif;?> 
                    <div class="content">
