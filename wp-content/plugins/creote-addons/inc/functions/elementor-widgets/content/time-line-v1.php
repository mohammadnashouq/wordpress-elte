<?php
   ...
   class Widget_creote_timeline_v1 extends Widget_Base
   {
       ...
       protected function render()
       {
           ...
           ?> 
<section class="time_line_section <?php echo esc_attr($settings['time_line_style']) ?>">
   <div class="swiper-container <?php echo esc_attr($class_name); ?>">
      ...
      <div class="swiper-wrapper">
         <?php foreach($settings['timeline_content_repeater'] as $timeline_content): 
            $target = $timeline_content['link_box']['is_external'] ? ' target="_blank"' : '';
            $nofollow = $timeline_content['link_box']['nofollow'] ? ' rel="nofollow"' : ''; 
            ?>
         <?php if($settings['time_line_style'] == 'style_one'): ?>
         <div class="swiper-slide">
            <div class="time_line_box">
               <div class="time_inner">
                  ...
                  <div class="content">
                     <h2>
                        <a href="<?php echo esc_url($timeline_content['link_box']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>>
                  ...
                  <?php if(!empty($timeline_content['image']['url'])): ?>
                  <div class="image">
                     <img src="<?php echo esc_url($timeline_content['image']['url']); ?>" alt="img" />
                  </div>
                  <?php endif; ?>
               </div>
            </div>
         </div>
         <?php elseif($settings['time_line_style'] == 'style_two'): ?>
         <div class="swiper-slide">
            <div class="event_box type_two">
               <div class="date_box ">
                  <h6><?php echo wp_kses($timeline_content['timeline_date'] , $allowed_tags); ?></h6>
               </div>
   ...
   <?php if($settings['arrow_enable'] == 'yes'): ?>
      ...
      <div class="next-single-one_three">
      </div>
      <div class="prev-single-one_three">
      </div>
      </div>
      <?php endif; ?>
</section>
