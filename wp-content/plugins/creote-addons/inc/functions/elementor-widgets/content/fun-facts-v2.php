...
<section class="section__counter">
   <?php if($settings['counter_style'] == 'style_one'): ?>
   <div class="counter-block style_one count-box" <?php if($settings['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($settings['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
      <div class="icon_box  <?php if($settings['icon_type'] == 'icon_fonts_enable' ): ?> icon_yes <?php endif; ?>">
         ...
         <div class="icon">
            <img src="<?php echo esc_url($settings['icon_image']['url']); ?>" class="img-fluid svg_image" alt="<?php esc_attr_e('icon png', 'creote-addons'); ?>" />
         </div>
         <?php endif; ?>
      ...
      <div class="content_box">
         ...
         <h6><?php echo wp_kses($settings['fact_heading'] , $allowed_tags); ?></h6>
         <?php endif; ?>
   ...
   <?php elseif($settings['counter_style'] == 'style_two'): ?>
   <div class="counter-block style_two count-box" <?php if($settings['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($settings['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
      <div class="coun_ter">
         <span class="count-text" data-speed="1500" data-stop="<?php echo esc_attr($settings['counter_start']); ?>">0</span>
         <small><?php echo esc_attr($settings['fact_symbols']); ?></small>
      </div>
   ...
   <div class="counter-block style_three count-box" <?php if($settings['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($settings['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
      <div class="icon_box  <?php if($settings['icon_type'] == 'icon_fonts_enable'): ?> icon_yes <?php endif; ?>">
         <?php if($settings['icon_type'] == 'icon_image_enable' ): ?>
         <div class="icon">
            <img src="<?php echo esc_url($settings['icon_image']['url']); ?>" class="img-fluid svg_image" alt="<?php esc_attr_e('icon png', 'creote-addons'); ?>" />
