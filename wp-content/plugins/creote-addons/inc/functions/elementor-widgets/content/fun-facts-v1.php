...
<section class="section__counter <?php echo esc_attr($settings['column_count']); ?>">
   <div class="grid_show_case grid_layout clearfix">
      ...
      <div class="grid_box _card">
         <div class="counter-block style_one count-box" <?php if($counterblock['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($counterblock['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
            <div class="icon_box  <?php if($counterblock['icon_type'] == 'icon_fonts_enable' ): ?> icon_yes <?php endif; ?>">
               ...
               <div class="icon">
                  <img src="<?php echo esc_url($counterblock['icon_image']['url']); ?>" class="img-fluid svg_image" alt="<?php esc_attr_e('icon png', 'creote-addons'); ?>" />
               </div>
               <?php endif; ?>
      ...
      <div class="grid_box _card">
         <div class="counter-block style_two count-box" <?php if($counterblock['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($counterblock['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
            <div class="coun_ter">
               <span class="count-text" data-speed="1500" data-stop="<?php echo esc_attr($counterblock['counter_start']); ?>">0</span>
               <small><?php echo esc_attr($counterblock['fact_symbols']); ?></small>
            </div>
