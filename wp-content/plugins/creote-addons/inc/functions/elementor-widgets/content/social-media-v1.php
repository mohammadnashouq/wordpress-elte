...
<div class="social_media_v_one">
   <ul>
      ...
      <li <?php if($media['transitions_enable'] == 'yes'):  ?>  data-aos="fade-up" data-aos-delay="<?php echo esc_html($media['transitions']); ?>"  data-aos-offset="0" <?php endif;?>>
         <a href="<?php echo esc_url($media['media_link']); ?>"> <span class="<?php echo esc_attr($media['media_icon']); ?>"></span>
