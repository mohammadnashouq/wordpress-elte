...
<div class="theme_btn_all <?php echo esc_attr($settings['dark_white']); ?>">
   ...
   <a href="<?php echo esc_url($settings['button_link']['url']);?>"  <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?> class="theme-btn two">
   <?php echo esc_html($settings['button_text']);?>
   </a>
   <?php elseif($settings['theme_btn_styles'] == 'style_three'):?>
   ...
   <?php elseif($settings['theme_btn_styles'] == 'style_four'):?>
   <a href="<?php echo esc_url($settings['button_link']['url']);?>"  <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?> class="theme-btn four">
   <?php echo esc_html($settings['button_text']);?> <i class="icon-right-arrow"></i>
   </a>
   <?php elseif($settings['theme_btn_styles'] == 'style_five'):?>
   <a href="<?php echo esc_url($settings['button_link']['url']);?>"  <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?> class="theme-btn five">
   <?php echo esc_html($settings['button_text']);?> <i class="icon-right-arrow"></i>
   </a>
   <?php endif; ?>
</div>
