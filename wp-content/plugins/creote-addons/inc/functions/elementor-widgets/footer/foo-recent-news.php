<?php
   ...
   ?>
<div class="footer_widgets recent_news_em_wp <?php echo esc_attr($settings['news_styles']); ?>  clearfix">
   <div class="news_boxed <?php echo esc_attr($settings['dark_white']); ?>">
      <!-- swiper-slide -->
      <?php 
         $args = array(
            'post_type' => 'post',
      ...
      <div class="news_recent clearfix<?php if(has_post_thumbnail()): ?>  image_s  <?php endif;?>">
         ...
         <div class="content ">
            ...
            <a class="date"><span class="fa fa-clock-o"></span><?php  echo esc_attr(get_the_date(get_option('date_format'))); ?></a>
         </div>
      </div>
