<?php
   ...
   class Widget_creote_footer_copy_right_v1 extends Widget_Base
   {
       ...
       protected function render() {
   		...
   		?>
<div class="footer_copy_right <?php echo esc_attr($settings['copy_right_style']); ?>">
   <div class="row">
      <div class="col-lg-6 col-md-12">
         <div class="footer_copy_content">
            <?php echo wp_kses($settings['copy_right_content'] , $allowed_tags); ?>
         </div>
      </div>
      <?php if($settings['copy_right_style'] == 'style_one'): ?>
      <div class="col-lg-6 col-md-12">
      ...
      <?php elseif($settings['copy_right_style'] == 'style_two'): ?>
      <div class="col-lg-6 col-md-12">
         <div class="footer_copy_content_right">
            <div class="nav_link_v_one">
               <ul>
                  <?php foreach($settings['nav_repeater'] as $nav_repeater): ?>
                  <?php $target = $nav_repeater['link_go']['is_external'] ? ' target="_blank"' : '';
                     $nofollow = $nav_repeater['link_go']['nofollow'] ? ' rel="nofollow"' : ''; ?>
                  <li>
                     <a href="<?php echo esc_url($nav_repeater['link_go']['url']);?>"  <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?>>
