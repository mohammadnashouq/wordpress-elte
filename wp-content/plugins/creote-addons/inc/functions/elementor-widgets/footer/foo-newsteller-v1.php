   ...
   class Widget_creote_foo_subscribe_v1 extends Widget_Base
   {
       ...
       protected function register_controls() {
           ...
           $this->add_control(
               'subscribe_styles',
               [
                 'label' => __('Subscribe Styles', 'creote-addons'),
       ...
       protected function render() {
   		...
   		?>
<div class="footer_widgets foo_subscribe <?php echo esc_attr($settings['dark_white']); ?> <?php echo esc_attr($settings['subscribe_styles']); ?>">
   <?php if($settings['subscribe_styles'] == 'style_one'): ?>
   <div class="item_subscribe with_text">
      <?php if(!empty($settings['subscribe_short_description'])) : ?> 
      <p><?php echo wp_kses($settings['subscribe_short_description'] , $allowed_tags); ?></p>
      <?php endif; ?>   
      <?php if(!empty($settings['subscribe_short_code'])) : ?> 
      <div class="shortcodes">
         <?php echo do_shortcode( $settings['subscribe_short_code'] );?>
      </div>
      <?php endif; ?>  
      <?php if(!empty($settings['notes'])) : ?> 
      <p><?php echo wp_kses($settings['notes'] , $allowed_tags); ?></p>
      <?php endif; ?>  
   </div>
