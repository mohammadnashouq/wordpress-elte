...
protected function register_controls() {
    ...
    $this->add_control(
        ...
        [
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} .position-relative  , .position-relative  p , .position-relative h1 ,
                ...
                .position-relative ul li , .position-relative ul li a ' => 'color: {{VALUE}}!important;',
            ],
        ]
    );
    ...
    $this->add_group_control(
        ...
        [
            'name' => 'typography_crs',
            'selector' =>  '{{WRAPPER}} body .position-relative  , body .position-relative  p , body .position-relative h1 , body
                .position-relative h2 , body .position-relative h3 , body .position-relative h4 , body .position-relative h5 , body .position-relative h6 , body .position-relative a ,
                body  .position-relative ul li , body .position-relative ul li a '
        ]
    );
    ...
    $this->add_group_control(
        ...
        [
            ...
            'selector' =>  '{{WRAPPER}} body .position-relative  , body .position-relative  p , body .position-relative h1 ,
            body .position-relative h2 , body .position-relative h3 , body .position-relative h4 , body .position-relative h5 , body .position-relative h6 , body .position-relative a ,
            body .position-relative ul li , body .position-relative ul li a ' 
        ]
    );
