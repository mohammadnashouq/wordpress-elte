...
function vc_slider_v3_vcmap() {
 vc_map( array(
  "name" => __( "Slider V3", "creote-addons" ),
...
add_shortcode( 'vc_slider_v3_init', 'vc_single_banner_v3' );
function vc_single_banner_v3( $atts, $content = null ) { 
 $atts = shortcode_atts(
   array(
      'slider_repeater' => '',
      'border_radius' => '',
...
<section class="slider style_three  <?php echo esc_attr($atts['nav_positions']); ?>">
        <div class="banner_style_one swiper-container">
