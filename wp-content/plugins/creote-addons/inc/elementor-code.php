...
function creote_core_register_elementor_widgets(){
    // header 
   ...
   // require_once CREOTE_ADDONS_DIR . '/inc/functions/elementor-widgets/header-two/Header_v12.php';
    ...
    require_once CREOTE_ADDONS_DIR . '/inc/functions/elementor-widgets/content/blog-post-v1.php';
  ...
  add_action('elementor/widgets/widgets_registered', 'creote_core_register_elementor_widgets');
  ?>