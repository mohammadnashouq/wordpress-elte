...
if(!empty($page_header_bg_css)){
    $customize_css .= ' .page_header_default::before {' . $page_header_bg_css . '!important}';
}
...
$page_header_padding = $creote_theme_mod['page_header_padding'];
...
$page_header_mb_padding_css .= $page_header_mb_padding_top ? 'padding-right:' . $page_header_mb_padding_top . '!important; ' : '';
...
if(!empty($body_padding_totals_css)){
    $customize_css .= '@media(min-width:1200px) { body   {' . $body_padding_totals_css . '}}';
}
if(!empty($body_padding_total_mb_css)){
    $customize_css .= '@media(max-width:1200px) { body   {' . $body_padding_total_mb_css . '}}';
}
endif;
